...
## [0.8.1](https://github.com/Tanguille/LLMKube/compare/v0.9.13...v0.8.1) (2026-07-30)


### ⚠ BREAKING CHANGES

* **security:** gate local/hostPath model sources + block controller SSRF (GHSA-jw3m-8q7m-f35r) ([#981](https://github.com/Tanguille/LLMKube/issues/981))
...
* add --llama-server-port for a fixed llama-server runtime port ([#499](https://github.com/Tanguille/LLMKube/issues/499)) ([cc30b0d](https://github.com/Tanguille/LLMKube/commit/cc30b0dbd5cc8493547f3a251c11ad02d391aa58))
* add --prompt-depth-sweep to benchmark command ([#1280](https://github.com/Tanguille/LLMKube/issues/1280)) ([eb511f9](https://github.com/Tanguille/LLMKube/commit/eb511f93fec92bbe1520981f9cb186e65abae8c9))
* add defaultRouteStrategy with BackendNameMatch to ModelRouter ([#791](https://github.com/Tanguille/LLMKube/issues/791)) ([b7da779](https://github.com/Tanguille/LLMKube/commit/b7da779b3eac8ba76a376ef3e49596759831ffbe))
* add make lint-all target for cross-arch linting ([#508](https://github.com/Tanguille/LLMKube/issues/508)) ([f57dd5b](https://github.com/Tanguille/LLMKube/commit/f57dd5b0f5178a9c5d6e284a7f1bd5e36f1b282d))
* add spec.mode to auto-serve embedding and rerank models ([#866](https://github.com/Tanguille/LLMKube/issues/866)) ([a7fa09f](https://github.com/Tanguille/LLMKube/commit/a7fa09f295039ae7d3328f9155e745935931e9af))
* add topologySpreadConstraints and affinity to InferenceService ([#793](https://github.com/Tanguille/LLMKube/issues/793)) ([#794](https://github.com/Tanguille/LLMKube/issues/794)) ([0a24fed](https://github.com/Tanguille/LLMKube/commit/0a24fed918bda02198ff0fa2a7181a9935043bbb))
* add vulkan accelerator enum and make readiness-check Vulkan-aware ([#735](https://github.com/Tanguille/LLMKube/issues/735)) ([76cf370](https://github.com/Tanguille/LLMKube/commit/76cf3706ac50fb3ac65ef8537c923e79ac6e3aa0))
* **agent,controller:** heartbeat liveness for metal endpoint registrations ([#666](https://github.com/Tanguille/LLMKube/issues/666)) ([6a8cfe8](https://github.com/Tanguille/LLMKube/commit/6a8cfe8a2e8c4bbbb057e3efd9aa1d0f8e59e11c))
* AMD/Vulkan runtime image selection (hardware.gpu.runtime) ([#727](https://github.com/Tanguille/LLMKube/issues/727)) ([1a4544f](https://github.com/Tanguille/LLMKube/commit/1a4544fe54de673bb93443dd4971c35875cef017))
* **api:** add GPUQuota CRD types for multi-tenant GPU governance ([#1101](https://github.com/Tanguille/LLMKube/issues/1101)) ([5dd867a](https://github.com/Tanguille/LLMKube/commit/5dd867a5118dccdbb38a14e44a159d7cbcaf8727))
* **api:** vendor-neutral gpuSharing tiers on InferenceService ([#1196](https://github.com/Tanguille/LLMKube/issues/1196) stories 1+2) ([#1199](https://github.com/Tanguille/LLMKube/issues/1199)) ([6cbd1fd](https://github.com/Tanguille/LLMKube/commit/6cbd1fd7a8fd446783d0ed37f9b1955e5fbd8290))
* cache prep subcommand with direct chown/chmod syscalls ([#890](https://github.com/Tanguille/LLMKube/issues/890) item 3) ([#1258](https://github.com/Tanguille/LLMKube/issues/1258)) ([bde1a87](https://github.com/Tanguille/LLMKube/commit/bde1a87ecaeee6ea4cadecc7612942ed706fe1cd))
* capability-aware scheduler + AgenticTaskWatcher + stub executor (Foreman v0.1 M2) ([#504](https://github.com/Tanguille/LLMKube/issues/504)) ([74b3d6e](https://github.com/Tanguille/LLMKube/commit/74b3d6e1c47915ff1b7a6ac1025acd035f28cce7))
* **chart:** gate CRD installation behind crds.enabled toggle ([#998](https://github.com/Tanguille/LLMKube/issues/998)) ([acf2e6a](https://github.com/Tanguille/LLMKube/commit/acf2e6a23de8072ddd62ff129be7300ec8c12bf1))
* **chart:** gpuSharing pool + VRAM values wired to operator flags ([#1196](https://github.com/Tanguille/LLMKube/issues/1196) story 3) ([#1205](https://github.com/Tanguille/LLMKube/issues/1205)) ([95eed30](https://github.com/Tanguille/LLMKube/commit/95eed30e9ab67150779ff6b1523249a94b804f17))
* **charts/foreman:** expose the agent --accelerator flag ([#1242](https://github.com/Tanguille/LLMKube/issues/1242)) ([#1261](https://github.com/Tanguille/LLMKube/issues/1261)) ([a39fd71](https://github.com/Tanguille/LLMKube/commit/a39fd719791a528c79f96d2275d5967d871f328e))
* **chart:** support multiple agent fleets in one release ([#1028](https://github.com/Tanguille/LLMKube/issues/1028)) ([a9a6c6b](https://github.com/Tanguille/LLMKube/commit/a9a6c6bf2e40efddb16df80ac0ba4bdc7f7a71bb))
* **chart:** template Grafana dashboards, publishing runtime ones only while their runtime serves ([#1267](https://github.com/Tanguille/LLMKube/issues/1267)) ([c2d56b7](https://github.com/Tanguille/LLMKube/commit/c2d56b7d31746726e5dc79e2f4ce5f94b6452560))
* **ci:** publish Helm charts as OCI artifacts to GHCR ([#758](https://github.com/Tanguille/LLMKube/issues/758)) ([da07772](https://github.com/Tanguille/LLMKube/commit/da07772cdfdfb273afa3cdad6966d19763981d3f))
* **ci:** validate config/samples against CRD schemas (Fixes [#1021](https://github.com/Tanguille/LLMKube/issues/1021)) ([#1083](https://github.com/Tanguille/LLMKube/issues/1083)) ([b3ae847](https://github.com/Tanguille/LLMKube/commit/b3ae84711c8447e6e33c02ef3c55d9c1dc7d3741))
* **cli:** --revise-from-branch on foreman dispatch for in-place PR refresh ([#1043](https://github.com/Tanguille/LLMKube/issues/1043)) ([26f807b](https://github.com/Tanguille/LLMKube/commit/26f807bfe28652ae628ab9e5eca1a9ba33781ede))
* **cli:** add --node-port to pin a stable NodePort on InferenceService ([#737](https://github.com/Tanguille/LLMKube/issues/737)) ([a6c1a03](https://github.com/Tanguille/LLMKube/commit/a6c1a03002bdc8eac75c93c3ae36158a077fe9e5))
* **cli:** add --planner-token for gateway-routed planner (Fixes [#1053](https://github.com/Tanguille/LLMKube/issues/1053)) ([#1090](https://github.com/Tanguille/LLMKube/issues/1090)) ([f71d2cc](https://github.com/Tanguille/LLMKube/commit/f71d2cc425aefa093c08acd696896ba9ad6a7170))
* **cli:** add `llmkube foreman dispatch` to fan issues across coder agents ([#879](https://github.com/Tanguille/LLMKube/issues/879)) ([1530754](https://github.com/Tanguille/LLMKube/commit/1530754dbff1a1e6e47a187bbbcd71515d2ce4ef))
* **cli:** add `llmkube scale` subcommand to scale InferenceService replicas ([#736](https://github.com/Tanguille/LLMKube/issues/736)) ([bdb89f8](https://github.com/Tanguille/LLMKube/commit/bdb89f898bc31f00b714b05b4e2b5960b7db304d))
* **cli:** download heartbeat for llmkube deploy --wait ([#719](https://github.com/Tanguille/LLMKube/issues/719)) ([#780](https://github.com/Tanguille/LLMKube/issues/780)) ([e6f9774](https://github.com/Tanguille/LLMKube/commit/e6f9774816177a36136877dc0a31ffc63021179a))
* **cli:** envtest-verify the slicer's integrated branch (Fixes [#1137](https://github.com/Tanguille/LLMKube/issues/1137)) ([#1141](https://github.com/Tanguille/LLMKube/issues/1141)) ([a7622c2](https://github.com/Tanguille/LLMKube/commit/a7622c2a988fe8f1479d2411a21d27ffd7a18405))
* **cli:** explicit model-cache control flags on deploy/delete (Fixes [#722](https://github.com/Tanguille/LLMKube/issues/722)) ([#830](https://github.com/Tanguille/LLMKube/issues/830)) ([9fc4187](https://github.com/Tanguille/LLMKube/commit/9fc41876649a15f03d3121cd6a7bda07458b53af))
* **cli:** llmkube foreman slice renders a sliced Workload from a plan ([#1049](https://github.com/Tanguille/LLMKube/issues/1049)) ([ce586ed](https://github.com/Tanguille/LLMKube/commit/ce586ed73b5b51a6509273c0b08adf183db195a3))
* **cli:** make cache list per-InferenceService cache aware ([#731](https://github.com/Tanguille/LLMKube/issues/731)) ([#767](https://github.com/Tanguille/LLMKube/issues/767)) ([d03c9ee](https://github.com/Tanguille/LLMKube/commit/d03c9eed3727639a322d7143fe6ec993505fc66d))
* **cli:** plan an issue into slices in llmkube foreman slice ([#1050](https://github.com/Tanguille/LLMKube/issues/1050)) ([c4a967c](https://github.com/Tanguille/LLMKube/commit/c4a967c89735836980ea04e4666d69c9f2ca89c7))
* **controller:** add extraVolumes/extraVolumeMounts passthrough on InferenceService ([#1079](https://github.com/Tanguille/LLMKube/issues/1079)) ([80e004c](https://github.com/Tanguille/LLMKube/commit/80e004c3716c58f900ac9c43d2b5cd94ba25d896))
* **controller:** add GPUQuota status reconciler ([#1117](https://github.com/Tanguille/LLMKube/issues/1117)) ([1d583e4](https://github.com/Tanguille/LLMKube/commit/1d583e4cd611b5a5b19d2a73e254267c3f6464e1))
* **controller:** add GPUQuota validating webhook for InferenceService ([#1118](https://github.com/Tanguille/LLMKube/issues/1118)) ([26804bd](https://github.com/Tanguille/LLMKube/commit/26804bd8debe7c5884b50dcb5a2fafef69975926))
* **controller:** add InferenceService hardware-labels info metric ([#1121](https://github.com/Tanguille/LLMKube/issues/1121)) ([#1160](https://github.com/Tanguille/LLMKube/issues/1160)) ([039adaa](https://github.com/Tanguille/LLMKube/commit/039adaa926b76eb31bc36a512ea82e1ee70dd511))
* **controller:** add llamacpp-router runtime for multi-model serving ([#1152](https://github.com/Tanguille/LLMKube/issues/1152)) ([fae5983](https://github.com/Tanguille/LLMKube/commit/fae5983242226dd70eb1345c221b1188072b6d27))
* **controller:** add Model refreshPolicy + upstream drift detection ([#635](https://github.com/Tanguille/LLMKube/issues/635)) ([7dc5b14](https://github.com/Tanguille/LLMKube/commit/7dc5b1498a691ce5473e2ff459cb8afcf01124fd))
* **controller:** add s3:// model source via curl --aws-sigv4 ([#1098](https://github.com/Tanguille/LLMKube/issues/1098)) ([#1125](https://github.com/Tanguille/LLMKube/issues/1125)) ([ed35142](https://github.com/Tanguille/LLMKube/commit/ed3514269a668328c571e8e7d6583251ed58f81d))
* **controller:** bound InferenceService pod lifetime via maxPodLifetimeSeconds ([#1182](https://github.com/Tanguille/LLMKube/issues/1182)) ([3b39ee9](https://github.com/Tanguille/LLMKube/commit/3b39ee9d59c5745315aedbaecc7c0804127e5118))
* **controller:** defer rollouts until idle ([#913](https://github.com/Tanguille/LLMKube/issues/913)) ([aa404ff](https://github.com/Tanguille/LLMKube/commit/aa404ff0dd49e376bd4c50bffbc553a39db33791))
* **controller:** explicit vllm serve entrypoint for image-agnostic vLLM ([#1164](https://github.com/Tanguille/LLMKube/issues/1164)) ([#1165](https://github.com/Tanguille/LLMKube/issues/1165)) ([3eeb580](https://github.com/Tanguille/LLMKube/commit/3eeb580f31d6ac47c265b447638fdfbd2f92b0c3))
* **controller:** extend drain-before-roll idle checks to vLLM, TGI, SGLang, and multi-replica services ([#1088](https://github.com/Tanguille/LLMKube/issues/1088)) ([1d884df](https://github.com/Tanguille/LLMKube/commit/1d884dfa13627d2064e970727b5ae78cc52f2f10))
* **controller:** pass staged model directory to vLLM/SGLang for multi-file models ([#1157](https://github.com/Tanguille/LLMKube/issues/1157)) ([#1159](https://github.com/Tanguille/LLMKube/issues/1159)) ([a24fa94](https://github.com/Tanguille/LLMKube/commit/a24fa948038561d3e5b80ec0da84038844688c37))
* **controller:** real accelerator availability check for Model status ([#230](https://github.com/Tanguille/LLMKube/issues/230)) ([#610](https://github.com/Tanguille/LLMKube/issues/610)) ([f8652fd](https://github.com/Tanguille/LLMKube/commit/f8652fd796aae5cb5cf50556aa1fee96003fc569))
* **controller:** ROCm/HIP runtime tier for AMD nodes ([#701](https://github.com/Tanguille/LLMKube/issues/701)) ([#1154](https://github.com/Tanguille/LLMKube/issues/1154)) ([3704d47](https://github.com/Tanguille/LLMKube/commit/3704d476fa650449598330ca4b91950bdc3c7ed0))
* **controller:** run model-cache-prep init non-root + document PSA/multi-tenancy caveats ([#883](https://github.com/Tanguille/LLMKube/issues/883)) ([a8049f1](https://github.com/Tanguille/LLMKube/commit/a8049f1c5de258efb54c32167114cae1143ef34a))
* **controller:** shield inference pods from disruption during startup ([#660](https://github.com/Tanguille/LLMKube/issues/660)) ([#781](https://github.com/Tanguille/LLMKube/issues/781)) ([370084a](https://github.com/Tanguille/LLMKube/commit/370084a64282e848cc7238077272c354a8fa01ca))
* **controller:** vendor-neutral DRA (resource.k8s.io/v1) scheduling for InferenceService ([#750](https://github.com/Tanguille/LLMKube/issues/750)) ([6eb0f27](https://github.com/Tanguille/LLMKube/commit/6eb0f27d9b2e4c06b41af5855e7135ca5d7edc02))
* **crd:** make GPU resource name configurable to support AMD/Vulkan/Intel scheduling ([#709](https://github.com/Tanguille/LLMKube/issues/709)) ([c88becf](https://github.com/Tanguille/LLMKube/commit/c88becfdd9d25a0763a16d536403c6615fcbb313))
* declarative bindAddress on InferenceService ([#1240](https://github.com/Tanguille/LLMKube/issues/1240)) ([#1247](https://github.com/Tanguille/LLMKube/issues/1247)) ([bf01598](https://github.com/Tanguille/LLMKube/commit/bf01598d4dbd9583cf28d072307d05369eeb2281))
* expose oMLX TurboQuant KV cache quantization settings ([#905](https://github.com/Tanguille/LLMKube/issues/905)) ([68e0291](https://github.com/Tanguille/LLMKube/commit/68e02916ab594625c33daa008b1d1b025362594c))
* **federation:** FederatedCluster registry + fleet status rollup ([#1234](https://github.com/Tanguille/LLMKube/issues/1234), [#1235](https://github.com/Tanguille/LLMKube/issues/1235)) ([#1241](https://github.com/Tanguille/LLMKube/issues/1241)) ([1b5bf08](https://github.com/Tanguille/LLMKube/commit/1b5bf08f37f5c4b531642f6a205da1fc534f761d))
* **finalize:** gate foreman-finalize on the Foreman verify verdict ([#1150](https://github.com/Tanguille/LLMKube/issues/1150)) ([#1153](https://github.com/Tanguille/LLMKube/issues/1153)) ([5c7b2cd](https://github.com/Tanguille/LLMKube/commit/5c7b2cde7476c24dee0507d082e3751236385588))
* **foreman,agent:** report agent version to the cluster ([#672](https://github.com/Tanguille/LLMKube/issues/672)) ([8860cb6](https://github.com/Tanguille/LLMKube/commit/8860cb66f62d358e3b08351ffd9dbaf012e7fa77))
* **foreman,selfupdate:** agent self-update so approved AgentReleases roll the fleet ([#676](https://github.com/Tanguille/LLMKube/issues/676)) ([5917715](https://github.com/Tanguille/LLMKube/commit/59177153c3f4569fb0a48680e364077ff46431f3))
* **foreman/api:** structured AgenticTaskFailureReason taxonomy ([#565](https://github.com/Tanguille/LLMKube/issues/565)) ([6e72e85](https://github.com/Tanguille/LLMKube/commit/6e72e8599a4e6d97e44e026cbc1194df064fc65c))
* **foreman/loop:** observation masking for context-window management ([#563](https://github.com/Tanguille/LLMKube/issues/563)) ([d17c3e0](https://github.com/Tanguille/LLMKube/commit/d17c3e070416354fdfcc9b39c125f79603abea0d))
* **foreman/loop:** stuck-loop detector with nudge-then-force protocol ([#544](https://github.com/Tanguille/LLMKube/issues/544)) ([#569](https://github.com/Tanguille/LLMKube/issues/569)) ([2172ece](https://github.com/Tanguille/LLMKube/commit/2172ece33486c1a0a0c0b71cd4199b5d1f593854))
* **foreman/loop:** support hybrid-thinking models via reasoning_content ([#651](https://github.com/Tanguille/LLMKube/issues/651)) ([b178de2](https://github.com/Tanguille/LLMKube/commit/b178de2ad7aaf225ec241ef2deb291cce92b10da))
* **foreman/m6:** Workload reconciler with stub planner (explicit pipeline + issue-batch shortcut) ([#533](https://github.com/Tanguille/LLMKube/issues/533)) ([dbdcd46](https://github.com/Tanguille/LLMKube/commit/dbdcd46e5ee1578f6b0be02ac3bf270d3935d7e1))
* **foreman/reviewer:** computable scope-overlap check demotes drifted GO verdicts ([#648](https://github.com/Tanguille/LLMKube/issues/648)) ([8afe0c1](https://github.com/Tanguille/LLMKube/commit/8afe0c1813a3e4ffcb743b0821d54194aea9f40a))
* **foreman/reviewer:** demote unverifiable review verdicts to NO-GO ([#645](https://github.com/Tanguille/LLMKube/issues/645)) ([188dacd](https://github.com/Tanguille/LLMKube/commit/188dacd04dcb13d62fee660f55efa2dd855051ca))
* **foreman/reviewer:** fetch_issue tool replaces gh issue view subshell ([#581](https://github.com/Tanguille/LLMKube/issues/581)) ([0253e43](https://github.com/Tanguille/LLMKube/commit/0253e430f02a6d96a8a1ff05597dfb926aa0d411))
* **foreman/tools:** distinguish whitelist-excluded from unknown tool calls ([#564](https://github.com/Tanguille/LLMKube/issues/564)) ([089e9ca](https://github.com/Tanguille/LLMKube/commit/089e9ca5dd0dcfa9513eda09634f5030d007a707))
* **foreman/v0.2:** hybrid cloud reviewer Agent + sovereignty toggles ([#553](https://github.com/Tanguille/LLMKube/issues/553)) ([65a7cb8](https://github.com/Tanguille/LLMKube/commit/65a7cb874a492e9eba28888a95c600ebf6789d44))
* **foreman/v0.2:** WorkloadSpec.reviewerAgentRefs (plural) + third pipeline stage ([#551](https://github.com/Tanguille/LLMKube/issues/551)) ([831ae8c](https://github.com/Tanguille/LLMKube/commit/831ae8c501e6485d234acbd0b1aab2b34af8faf5))
* **foreman:** add a goreleaser-config check to the coder gate ([#882](https://github.com/Tanguille/LLMKube/issues/882)) ([c8535a7](https://github.com/Tanguille/LLMKube/commit/c8535a7c14a3d50eb9e1bbd3d7da464bd8424767))
* **foreman:** add AgentRelease CRD (scaffold for managed fleet updates) ([#674](https://github.com/Tanguille/LLMKube/issues/674)) ([55f7d9f](https://github.com/Tanguille/LLMKube/commit/55f7d9f11899978fd42fadfda04b5f8530007118))
* **foreman:** add opt-in NetworkPolicy to the Foreman Helm chart ([#625](https://github.com/Tanguille/LLMKube/issues/625)) ([8872b4d](https://github.com/Tanguille/LLMKube/commit/8872b4da7fd7e16672b6da4f12c750b71e166e05))
* **foreman:** add repo-map localization for coder Agents ([#560](https://github.com/Tanguille/LLMKube/issues/560)) ([#566](https://github.com/Tanguille/LLMKube/issues/566)) ([f6bf8c0](https://github.com/Tanguille/LLMKube/commit/f6bf8c08db5466bd5ed222c8bc4d009d6ddb1c3a))
* **foreman:** add unit-test tier to coder gate ([#763](https://github.com/Tanguille/LLMKube/issues/763)) ([dfb3d75](https://github.com/Tanguille/LLMKube/commit/dfb3d757380075c489c485298b4c2efa21954e4d))
* **foreman:** add vulkan to the accelerator routing enum ([#878](https://github.com/Tanguille/LLMKube/issues/878)) ([315dadc](https://github.com/Tanguille/LLMKube/commit/315dadc53286c88f50bd50a4a2093403899488d5))
* **foreman:** AgenticTask branches include workload name ([#573](https://github.com/Tanguille/LLMKube/issues/573)) ([#574](https://github.com/Tanguille/LLMKube/issues/574)) ([2986906](https://github.com/Tanguille/LLMKube/commit/2986906fc33b09932f03240bf0c1220b499e5a87))
* **foreman:** AgentRelease rollout controller (staged, health-gated, approved) ([#675](https://github.com/Tanguille/LLMKube/issues/675)) ([aa6bbd0](https://github.com/Tanguille/LLMKube/commit/aa6bbd05ec156a0b4414825a7f47e3cb915a86cd))
* **foreman:** append actionable steers to structural-lint gate feedback ([#984](https://github.com/Tanguille/LLMKube/issues/984)) ([4d496c6](https://github.com/Tanguille/LLMKube/commit/4d496c6b0a01365ecfbbe6a80ad6ff392fe91f61))
* **foreman:** bite check in the verify-gate Job (reject non-biting tests) ([#803](https://github.com/Tanguille/LLMKube/issues/803)) ([6f14b43](https://github.com/Tanguille/LLMKube/commit/6f14b432f34c73f341dfc08ddcb0f5d6f7de8537))
* **foreman:** bounded fix iteration on reviewer NO-GO instead of terminal failure ([#959](https://github.com/Tanguille/LLMKube/issues/959)) ([d820fff](https://github.com/Tanguille/LLMKube/commit/d820fffa8839a591d448f5368bee9f1c9e3d58a2))
* **foreman:** branch the coder off upstream/main, not the stale fork base ([#875](https://github.com/Tanguille/LLMKube/issues/875)) ([f4c382c](https://github.com/Tanguille/LLMKube/commit/f4c382c168dc9acb989f5d9518492cd9f73763a5))
* **foreman:** closest-line fallback when str_replace has no unique anchor ([#1000](https://github.com/Tanguille/LLMKube/issues/1000)) ([02ec677](https://github.com/Tanguille/LLMKube/commit/02ec6776634ee6732b2c238f0921d691c67e1264))
* **foreman:** codegen-drift check in the coder fast gate ([#775](https://github.com/Tanguille/LLMKube/issues/775)) ([#778](https://github.com/Tanguille/LLMKube/issues/778)) ([b04a28d](https://github.com/Tanguille/LLMKube/commit/b04a28dcbd0660c4c21e36bedc17a83a0e62620b))
* **foreman:** coder clones/pushes each task's own repo when no static remote ([#924](https://github.com/Tanguille/LLMKube/issues/924)) ([88c334d](https://github.com/Tanguille/LLMKube/commit/88c334df23d694b3db0779f94ef04ba2b203992a))
* **foreman:** coder gate mutation checks (test-presence + neuter-survival) ([#899](https://github.com/Tanguille/LLMKube/issues/899)) ([b235932](https://github.com/Tanguille/LLMKube/commit/b235932461106ac887d77223e48f79163db15f15))
* **foreman:** coder grounding rail (flag doc-contradicting metric writes) ([#1017](https://github.com/Tanguille/LLMKube/issues/1017)) ([aa969ed](https://github.com/Tanguille/LLMKube/commit/aa969ed6c490ef075aeb4ec0f5cabdd71c384c7e))
* **foreman:** coder-tier escalation, re-dispatch a failed coder to a larger model ([#964](https://github.com/Tanguille/LLMKube/issues/964)) ([ce8f655](https://github.com/Tanguille/LLMKube/commit/ce8f6555115602c3bcc7b116a6bf63471ec3638d))
* **foreman:** controller/metal-agent runtime-arg parity guard ([#918](https://github.com/Tanguille/LLMKube/issues/918)) ([92d3c1b](https://github.com/Tanguille/LLMKube/commit/92d3c1ba649ff3d11d3ab009cef6fe1788e3a363))
* **foreman:** detect changed envtest packages + gate-job delegation seam (part 1 of [#859](https://github.com/Tanguille/LLMKube/issues/859)) ([#860](https://github.com/Tanguille/LLMKube/issues/860)) ([c745127](https://github.com/Tanguille/LLMKube/commit/c7451274e4c47ffb2c1c481ea7ba33f67ddc4a84))
* **foreman:** deterministic coder verification gate with feedback loop ([#749](https://github.com/Tanguille/LLMKube/issues/749)) ([8cf3295](https://github.com/Tanguille/LLMKube/commit/8cf32956b4b448bb2ae37e4ff048e532e6668663))
* **foreman:** deterministically resolve codegen drift in the coder gate ([#874](https://github.com/Tanguille/LLMKube/issues/874)) ([332f7eb](https://github.com/Tanguille/LLMKube/commit/332f7eb6b14fa01156ff4226622e429e852309bb))
* **foreman:** distinct ALREADY-RESOLVED coder outcome ([#970](https://github.com/Tanguille/LLMKube/issues/970)) ([#1011](https://github.com/Tanguille/LLMKube/issues/1011)) ([8e041e0](https://github.com/Tanguille/LLMKube/commit/8e041e0d56b2b0f0649d87954f97c6ebeb7a8198))
* **foreman:** durable audit-log record + llmkube audit export ([#837](https://github.com/Tanguille/LLMKube/issues/837)) ([#838](https://github.com/Tanguille/LLMKube/issues/838)) ([57d2ad0](https://github.com/Tanguille/LLMKube/commit/57d2ad08ce24cf690ce9fd9e99adce0bce8f145e))
* **foreman:** durable FleetNode labels via --node-labels (survive pod restart) ([#885](https://github.com/Tanguille/LLMKube/issues/885)) ([fdda5a8](https://github.com/Tanguille/LLMKube/commit/fdda5a8f0b99fe1da528659ea54cfece091983d7))
* **foreman:** escalation-only reviewer emission on base NO-GO ([#639](https://github.com/Tanguille/LLMKube/issues/639)) ([d596ce3](https://github.com/Tanguille/LLMKube/commit/d596ce3ecbbbb15fbbd1589ec3b77234834f92db))
* **foreman:** executor fetches GitHub issue body when payload prompt is empty ([#571](https://github.com/Tanguille/LLMKube/issues/571)) ([#572](https://github.com/Tanguille/LLMKube/issues/572)) ([2b5bd31](https://github.com/Tanguille/LLMKube/commit/2b5bd318ad897c90679f2ac0e378a30e07a8425f))
* **foreman:** executor-owned revise-from-branch restore for revision tasks ([#967](https://github.com/Tanguille/LLMKube/issues/967)) ([b76051c](https://github.com/Tanguille/LLMKube/commit/b76051c77ab352a7d2585af87b0fa53cc5a11522))
* **foreman:** expose CRD status as Prometheus metrics via CRS (Fixes [#1001](https://github.com/Tanguille/LLMKube/issues/1001)) ([#1086](https://github.com/Tanguille/LLMKube/issues/1086)) ([a459748](https://github.com/Tanguille/LLMKube/commit/a45974879ed135c49bb38e525c8281e40de53c55))
* **foreman:** flag a GO that changes no functional production code ([#1024](https://github.com/Tanguille/LLMKube/issues/1024)) ([3e1a6fb](https://github.com/Tanguille/LLMKube/commit/3e1a6fb32bcdb7156eec17ea5fdf07823b40108e))
* **foreman:** flag unverifiable facts instead of inventing them (slicer anti-confabulation) ([#1062](https://github.com/Tanguille/LLMKube/issues/1062)) ([81bbfe9](https://github.com/Tanguille/LLMKube/commit/81bbfe9f03fd10018dfce4e2fa2944c779b17fbe))
* **foreman:** gate-role Agent on a verifier node (M4) ([#518](https://github.com/Tanguille/LLMKube/issues/518)) ([40a340e](https://github.com/Tanguille/LLMKube/commit/40a340e09f3e1845b0ad5bc0b549985fd0d92ab1))
* **foreman:** GateProfile API type + language presets + resolver (Addresses [#839](https://github.com/Tanguille/LLMKube/issues/839)) ([#840](https://github.com/Tanguille/LLMKube/issues/840)) ([165a375](https://github.com/Tanguille/LLMKube/commit/165a375ec52a2e9a786e2d0eca67853f3be0e9a8))
* **foreman:** grounded-finding rail for reviewer NO-GO verdicts ([#988](https://github.com/Tanguille/LLMKube/issues/988)) ([cadbd30](https://github.com/Tanguille/LLMKube/commit/cadbd3035253886accb37a5ded49291be5bda512))
* **foreman:** guide coders to verify volatile external facts via MCP research tools ([#1134](https://github.com/Tanguille/LLMKube/issues/1134)) ([390c945](https://github.com/Tanguille/LLMKube/commit/390c945cf5d64beb46863fe974ba4c8e039a99cd))
* **foreman:** honest-verdict slice 1 (claim evidence + work-class policy) ([#1078](https://github.com/Tanguille/LLMKube/issues/1078)) ([6f2c216](https://github.com/Tanguille/LLMKube/commit/6f2c2167747c546d72476691bf371b410690008c))
* **foreman:** in-executor envtest gate feedback loop ([#768](https://github.com/Tanguille/LLMKube/issues/768)) ([#1135](https://github.com/Tanguille/LLMKube/issues/1135)) ([074544a](https://github.com/Tanguille/LLMKube/commit/074544a64ec35c9fe08ed8e5b003b22799947f19))
* **foreman:** integrate + reconcile AgenticTask kinds + slice payload ([#1037](https://github.com/Tanguille/LLMKube/issues/1037)) ([0899e9f](https://github.com/Tanguille/LLMKube/commit/0899e9f9651747df5837d46b229bca6de80b9cc3))
* **foreman:** integrate library for disjoint slice union ([#1036](https://github.com/Tanguille/LLMKube/issues/1036)) ([39131f6](https://github.com/Tanguille/LLMKube/commit/39131f6d707b9190385175c89fa8d4f718a9726e))
* **foreman:** Job execution strategy for remote-model coder/reviewer Agents ([#620](https://github.com/Tanguille/LLMKube/issues/620)) ([#621](https://github.com/Tanguille/LLMKube/issues/621)) ([2317ac0](https://github.com/Tanguille/LLMKube/commit/2317ac03689c29d4acb8cd26c745e7da17f6f57f))
* **foreman:** loop convergence forcing (EditFreeStreak + final-turns submit) ([#741](https://github.com/Tanguille/LLMKube/issues/741)) ([cd3f068](https://github.com/Tanguille/LLMKube/commit/cd3f068d7557a5e228696e87d7abe594ff549810))
* **foreman:** make the EditFreeStreak guard grounding-aware ([#1067](https://github.com/Tanguille/LLMKube/issues/1067)) ([63a71ae](https://github.com/Tanguille/LLMKube/commit/63a71ae5e3278cf927f3f0e9c1c7e3781b77d36e))
* **foreman:** make the verify gate optional in the issue-batch decomposition ([#1166](https://github.com/Tanguille/LLMKube/issues/1166)) ([e4e49aa](https://github.com/Tanguille/LLMKube/commit/e4e49aa34e8809947679cd6bfe9b08964637aa20))
* **foreman:** MCP client for agents (Phase 1: HTTP transport, context7) ([#1014](https://github.com/Tanguille/LLMKube/issues/1014)) ([d34343f](https://github.com/Tanguille/LLMKube/commit/d34343fb8a53cec4bf7caa41380fcf2dfd253835))
* **foreman:** ModelProfile CRD for per-model harness tuning ([#862](https://github.com/Tanguille/LLMKube/issues/862)) ([#863](https://github.com/Tanguille/LLMKube/issues/863)) ([90ad28b](https://github.com/Tanguille/LLMKube/commit/90ad28bca52fcb04128fdf6f44bef8bbc4698203))
* **foreman:** native agent loop + Agent CRD + coder role on M5 Max (M3) ([#509](https://github.com/Tanguille/LLMKube/issues/509)) ([6661343](https://github.com/Tanguille/LLMKube/commit/666134373653bc621bf0c411db300f61f83f447b))
* **foreman:** open the pull request on review GO ([#956](https://github.com/Tanguille/LLMKube/issues/956)) ([fd852e1](https://github.com/Tanguille/LLMKube/commit/fd852e1957874fda837e5d96dc4b2c28f4116d38))
* **foreman:** opt-in coder escalation on capability-wall failures ([#1108](https://github.com/Tanguille/LLMKube/issues/1108)) ([#1128](https://github.com/Tanguille/LLMKube/issues/1128)) ([68e2211](https://github.com/Tanguille/LLMKube/commit/68e221129cbd3e512614faeca5ca8f6ad9e496d1))
* **foreman:** per-Agent contextStrategy with session mode (stable cache-friendly prefix) ([#757](https://github.com/Tanguille/LLMKube/issues/757)) ([3b1ea1c](https://github.com/Tanguille/LLMKube/commit/3b1ea1c1e417424e76f39266501334680071eed8))
* **foreman:** post-M4 stability follow-ups for v5-batch readiness ([#535](https://github.com/Tanguille/LLMKube/issues/535)) ([a841612](https://github.com/Tanguille/LLMKube/commit/a841612b07bc2cbc57cda2383a1846976bdfff22))
* **foreman:** post-push envtest gate (closes the in-loop timing flaw) ([#859](https://github.com/Tanguille/LLMKube/issues/859)) ([#864](https://github.com/Tanguille/LLMKube/issues/864)) ([71da4e2](https://github.com/Tanguille/LLMKube/commit/71da4e2ed383a064377be6252f3d8577418478b3))
* **foreman:** preserve a coder's gate-failed branch instead of discarding it ([#1115](https://github.com/Tanguille/LLMKube/issues/1115)) ([bc39c77](https://github.com/Tanguille/LLMKube/commit/bc39c77fec4707b553d4925ebe7e7ea0304f680e))
* **foreman:** propagate gateProfile from Workload to decomposed tasks ([#920](https://github.com/Tanguille/LLMKube/issues/920)) ([270b2fa](https://github.com/Tanguille/LLMKube/commit/270b2facc0bfdb706fba7be5daebc55a9f29ae2f))
* **foreman:** provider-neutral CodeHost/WorkItems/ChangePolicy seams ([#1158](https://github.com/Tanguille/LLMKube/issues/1158)) ([#1161](https://github.com/Tanguille/LLMKube/issues/1161)) ([d3a8ad6](https://github.com/Tanguille/LLMKube/commit/d3a8ad65b36375ef7808d8c3f0f52b72282efdfd))
* **foreman:** reconcile library for sliced-workload interface drift ([#1034](https://github.com/Tanguille/LLMKube/issues/1034)) ([b14f687](https://github.com/Tanguille/LLMKube/commit/b14f687b07c6afb88c9902f9a7812627cf8a4346))
* **foreman:** reference-grounding check in the coder gate ([#906](https://github.com/Tanguille/LLMKube/issues/906)) ([6296496](https://github.com/Tanguille/LLMKube/commit/62964966b514c1bed0705f74086dc56d4089edba))
* **foreman:** reviewer rubric checks for test/prod fidelity (real values + wired-up) ([#802](https://github.com/Tanguille/LLMKube/issues/802)) ([4353f3a](https://github.com/Tanguille/LLMKube/commit/4353f3adf9492e43b2e4684830cc466ffd2046af))
* **foreman:** reviewer.md single source of truth for reviewer prompts ([#804](https://github.com/Tanguille/LLMKube/issues/804)) ([#812](https://github.com/Tanguille/LLMKube/issues/812)) ([7b62b17](https://github.com/Tanguille/LLMKube/commit/7b62b1766eb46693d122b6f3d753a94c9fb35ac5))
* **foreman:** run the fast gate from the resolved GateProfile (Addresses [#839](https://github.com/Tanguille/LLMKube/issues/839)) ([#841](https://github.com/Tanguille/LLMKube/issues/841)) ([4225da4](https://github.com/Tanguille/LLMKube/commit/4225da46950ef467693300369480f69d89f57ec5))
* **foreman:** run_integrate tool for sliced-workload union ([#1045](https://github.com/Tanguille/LLMKube/issues/1045)) ([5098b4e](https://github.com/Tanguille/LLMKube/commit/5098b4ec86f11414f3e4de0df9040d0f0dd2853e))
* **foreman:** run_reconcile tool for sliced-workload drift check ([#1046](https://github.com/Tanguille/LLMKube/issues/1046)) ([6bde143](https://github.com/Tanguille/LLMKube/commit/6bde14346aee1acd53753688e9f8b016a5048874))
* **foreman:** scope guard reads source extensions from GateProfile (Addresses [#839](https://github.com/Tanguille/LLMKube/issues/839)) ([#842](https://github.com/Tanguille/LLMKube/issues/842)) ([c36ac87](https://github.com/Tanguille/LLMKube/commit/c36ac8795588f43a2560f5a0e0f375052c52817d))
* **foreman:** scope-overlap guard catches wrong-subsystem coder drift ([#876](https://github.com/Tanguille/LLMKube/issues/876)) ([795bf23](https://github.com/Tanguille/LLMKube/commit/795bf2380168d0351b3259205f6644b59a581bfe))
* **foreman:** semantic issueAsk verification instead of verbatim substring ([#1020](https://github.com/Tanguille/LLMKube/issues/1020)) ([85d92ee](https://github.com/Tanguille/LLMKube/commit/85d92eebaab65aa902675ef2d70f1d97283901c6))
* **foreman:** ship default integrate/reconcile Agents for sliced workloads ([#1052](https://github.com/Tanguille/LLMKube/issues/1052)) ([00dd7c0](https://github.com/Tanguille/LLMKube/commit/00dd7c003a393698a467b2a19d0ea3f646b02684))
* **foreman:** str_replace escalates to write_file after repeated failures ([#1026](https://github.com/Tanguille/LLMKube/issues/1026)) ([de1b8cb](https://github.com/Tanguille/LLMKube/commit/de1b8cbc89d1a9da6de123156b7563b2a5ae513b))
* **foreman:** str_replace fuzzy recovery for old_string drift + write_file steering ([#943](https://github.com/Tanguille/LLMKube/issues/943)) ([bab4631](https://github.com/Tanguille/LLMKube/commit/bab463120c56a4067ebf0fa17eecfa9e96a5902a))
* **foreman:** support chat_template_kwargs on agent chat requests ([#1285](https://github.com/Tanguille/LLMKube/issues/1285)) ([1028335](https://github.com/Tanguille/LLMKube/commit/102833581be53fdcc56b0ee5f28b62f17e8fe599))
* **foreman:** test-dilution advisory for the coder gate ([#1332](https://github.com/Tanguille/LLMKube/issues/1332)) ([#1337](https://github.com/Tanguille/LLMKube/issues/1337)) ([43a30fc](https://github.com/Tanguille/LLMKube/commit/43a30fc68f7d1729c131ae4e7e4ba8cbb662dd1b))
* **foreman:** tiered str_replace matching (exact, trailing-ws, uniform-indent) ([#1231](https://github.com/Tanguille/LLMKube/issues/1231)) ([0372e24](https://github.com/Tanguille/LLMKube/commit/0372e2425fbf2431d0fa20a2f7f02c07a69e7f9c))
* **foreman:** two-tier gate-check suite for the coder gate ([#931](https://github.com/Tanguille/LLMKube/issues/931)) ([f7f469e](https://github.com/Tanguille/LLMKube/commit/f7f469e60b9e46466e8125936cdea39257344147))
* **foreman:** use the reviewer's summary as the opened-PR body ([#975](https://github.com/Tanguille/LLMKube/issues/975)) ([e031ff5](https://github.com/Tanguille/LLMKube/commit/e031ff56c892f1cde0908f7939ba9818278abcfd))
* **foreman:** v0.4 reviewer agent — tool-using reviewer with sharpened prompt + structured findings ([#575](https://github.com/Tanguille/LLMKube/issues/575)) ([#576](https://github.com/Tanguille/LLMKube/issues/576)) ([06091a9](https://github.com/Tanguille/LLMKube/commit/06091a9e78922ee091a8cb9063732b4515626140))
* **foreman:** validating webhook for Agent + AgenticTask CRs ([#685](https://github.com/Tanguille/LLMKube/issues/685)) ([1935da7](https://github.com/Tanguille/LLMKube/commit/1935da775dafcbb1ea25c3f6d763df42693163e7))
* **foreman:** verdict-from-findings rail (promote GO with a grounded blocker) ([#992](https://github.com/Tanguille/LLMKube/issues/992)) ([b82fcca](https://github.com/Tanguille/LLMKube/commit/b82fccab3f8408583df6c70ec4a625b1d1f6bfa7))
* **foreman:** verify-gate Job image from GateProfile (Addresses [#839](https://github.com/Tanguille/LLMKube/issues/839)) ([#843](https://github.com/Tanguille/LLMKube/issues/843)) ([327dd88](https://github.com/Tanguille/LLMKube/commit/327dd88e8f7f547a46f3f1ce656aa87477c73132))
* **foreman:** verify-gate Job runs resolved commands for non-Go profiles (Addresses [#839](https://github.com/Tanguille/LLMKube/issues/839)) ([#844](https://github.com/Tanguille/LLMKube/issues/844)) ([84994fd](https://github.com/Tanguille/LLMKube/commit/84994fd0283a92faf182b0761f66e83ad3735eea))
* **foreman:** workspace-scoped bash + WORKSPACE_ROOT contract ([#567](https://github.com/Tanguille/LLMKube/issues/567)) ([#568](https://github.com/Tanguille/LLMKube/issues/568)) ([061eb41](https://github.com/Tanguille/LLMKube/commit/061eb4100d3055d236fe04f42cb079dd08af9631))
* **gateway:** active HTTP health checks on the ModelRouter BTP for fast backend ejection ([#662](https://github.com/Tanguille/LLMKube/issues/662)) ([#704](https://github.com/Tanguille/LLMKube/issues/704)) ([ba99060](https://github.com/Tanguille/LLMKube/commit/ba990606b1b9cc776d491337d8e85883e2e4b8bc))
* **gateway:** event-driven route-level ejection of unhealthy backends ([#662](https://github.com/Tanguille/LLMKube/issues/662)) ([#706](https://github.com/Tanguille/LLMKube/issues/706)) ([815f2bf](https://github.com/Tanguille/LLMKube/commit/815f2bf9aed37e9098c23bc40941fe0b22347f1b))
* **gateway:** gateway-scoped audit access log + fail-loud auditLog in Gateway mode (2c) ([#703](https://github.com/Tanguille/LLMKube/issues/703)) ([b874b5e](https://github.com/Tanguille/LLMKube/commit/b874b5e0eda49f9ee152cd2ae1bb8d8a4c923bfd))
* **gateway:** header-only data-classification routing + fail-closed sensitive guard (2e-core) ([#707](https://github.com/Tanguille/LLMKube/issues/707)) ([0249665](https://github.com/Tanguille/LLMKube/commit/02496656d109fb5be33bf9ec93186b141610acca))
* **gateway:** InferenceService Envoy AI Gateway exposure (MVP) ([#692](https://github.com/Tanguille/LLMKube/issues/692)) ([3b095dc](https://github.com/Tanguille/LLMKube/commit/3b095dc7b0ce6cfb50f6691db4560cb9a4a47cca))
* **gateway:** ModelRouter dataPlane Gateway mode with cross-tier failover (2a) ([#693](https://github.com/Tanguille/LLMKube/issues/693)) ([2842634](https://github.com/Tanguille/LLMKube/commit/2842634b9059fbec67815f2b64c283f4c456162c))
* **gateway:** ModelRouter JWT authentication via SecurityPolicy (2d-core) ([#695](https://github.com/Tanguille/LLMKube/issues/695)) ([73a2ea9](https://github.com/Tanguille/LLMKube/commit/73a2ea9493b9c261a0e91c6c610d3820f088bc03))
* **gateway:** ModelRouter per-team model allowlists via SecurityPolicy authorization (2d.2) ([#702](https://github.com/Tanguille/LLMKube/issues/702)) ([94428b4](https://github.com/Tanguille/LLMKube/commit/94428b4df745e1ce1b163971a45a42be2aa92de8))
* **gateway:** ModelRouter token budgets and 429 enforcement (2b) ([#694](https://github.com/Tanguille/LLMKube/issues/694)) ([627e85a](https://github.com/Tanguille/LLMKube/commit/627e85ac1e9d46a0afbd35b186ae970fe749d168))
* **gpu:** add Intel GPU (oneAPI/SYCL) support across controller, CLI, docs, and e2e ([#557](https://github.com/Tanguille/LLMKube/issues/557)) ([741ef5d](https://github.com/Tanguille/LLMKube/commit/741ef5db256055a66cda0532c9272f98b96b5568))
* **grafana:** add SGLang and vLLM runtime dashboards ([#1266](https://github.com/Tanguille/LLMKube/issues/1266)) ([07f340a](https://github.com/Tanguille/LLMKube/commit/07f340acda8b0035be4190eea5c50dffbb3e5f0c))
* **grafana:** chart the InferenceService metrics with no panel ([#1245](https://github.com/Tanguille/LLMKube/issues/1245)) ([a5ce923](https://github.com/Tanguille/LLMKube/commit/a5ce92340fa94fe9ec08edbd41147836898221a0))
* **grafana:** union llama.cpp, sglang and vLLM metrics on the inference dashboard ([#1248](https://github.com/Tanguille/LLMKube/issues/1248)) ([7cb226b](https://github.com/Tanguille/LLMKube/commit/7cb226b3fce501d68e1e89756e0c61c9091cb397))
* **grafana:** window-suffix variable so the SLO dashboard works for non-default windows ([#1148](https://github.com/Tanguille/LLMKube/issues/1148)) ([#1211](https://github.com/Tanguille/LLMKube/issues/1211)) ([8f7b70e](https://github.com/Tanguille/LLMKube/commit/8f7b70e98fa1dc24715ace680bd0cc8d11ddc3ef))
* **hack:** spine probes for models given repo access ([#1274](https://github.com/Tanguille/LLMKube/issues/1274)) ([b7b3d9b](https://github.com/Tanguille/LLMKube/commit/b7b3d9b9612c7587f4a2aed1bd32c95849c97343))
* **helm:** gate InferenceService quota webhook and tenant RBAC behind multitenancy toggle ([#1122](https://github.com/Tanguille/LLMKube/issues/1122)) ([26a994e](https://github.com/Tanguille/LLMKube/commit/26a994ef54f71d84614abd9db8b789f0b57e4d2f))
* **inference:** add spec.modelCache.claimName for user-owned cache PVCs ([#960](https://github.com/Tanguille/LLMKube/issues/960)) ([aab5a58](https://github.com/Tanguille/LLMKube/commit/aab5a58bf70b4752ab94a53d0f5175e877327172))
* **inferenceservice:** speculativeDecoding for llama.cpp MTP/draft (Fixes [#502](https://github.com/Tanguille/LLMKube/issues/502)) ([#827](https://github.com/Tanguille/LLMKube/issues/827)) ([564726a](https://github.com/Tanguille/LLMKube/commit/564726a773e06a2eab8fb2951836ca2891dd7a50))
* **inferenceservice:** typed spec.ropeScaling for RoPE/YaRN context extension ([#507](https://github.com/Tanguille/LLMKube/issues/507)) ([#600](https://github.com/Tanguille/LLMKube/issues/600)) ([a554aee](https://github.com/Tanguille/LLMKube/commit/a554aeef1e8f76d3d06d00b91ac779ef563c2000))
* Kueue prerequisites: spec.suspend, GPUQuota deferral, pkg/apiutil GPU mapping ([#1254](https://github.com/Tanguille/LLMKube/issues/1254)) ([c95e06f](https://github.com/Tanguille/LLMKube/commit/c95e06f0ddf1a86f1e867c65ce30a63331e7a709))
* **metal-agent:** event-driven endpoint withdrawal/recovery on health transitions ([#662](https://github.com/Tanguille/LLMKube/issues/662)) ([#771](https://github.com/Tanguille/LLMKube/issues/771)) ([7848d18](https://github.com/Tanguille/LLMKube/commit/7848d1803be8322855d2635954f2afbe4dbc3cef))
* **metal-agent:** expose oMLX paged SSD cache configuration ([#278](https://github.com/Tanguille/LLMKube/issues/278)) ([#1129](https://github.com/Tanguille/LLMKube/issues/1129)) ([095e4a2](https://github.com/Tanguille/LLMKube/commit/095e4a21733a2873d2282645c6d1337fc7a9e00f))
* **metal-agent:** honor spec.runtime per-CR for multi-runtime dispatch ([#525](https://github.com/Tanguille/LLMKube/issues/525)) ([#783](https://github.com/Tanguille/LLMKube/issues/783)) ([aa210c3](https://github.com/Tanguille/LLMKube/commit/aa210c346f8ae06742fb29f3ecc0f9d7e9247528))
* **metal-agent:** InferenceService name allowlist for multi-Mac fleets ([#555](https://github.com/Tanguille/LLMKube/issues/555)) ([67361f3](https://github.com/Tanguille/LLMKube/commit/67361f385256766969fc65d5994e169609f597d4))
* **metal-agent:** stable host-side client proxy on a fixed port ([#406](https://github.com/Tanguille/LLMKube/issues/406)) ([#608](https://github.com/Tanguille/LLMKube/issues/608)) ([5b4ea34](https://github.com/Tanguille/LLMKube/commit/5b4ea34acd1b4a4fbf1736aeb34c7e7b52324a5c))
* **metal-agent:** withdraw endpoint when runtime is unhealthy ([#662](https://github.com/Tanguille/LLMKube/issues/662)) ([#705](https://github.com/Tanguille/LLMKube/issues/705)) ([5ed9395](https://github.com/Tanguille/LLMKube/commit/5ed9395af9de8aa206c55a6a584d3c5a32a0b197))
* **metrics:** emit GPUQuota usage + admission-denial metrics ([#416](https://github.com/Tanguille/LLMKube/issues/416)) ([#1193](https://github.com/Tanguille/LLMKube/issues/1193)) ([dad2687](https://github.com/Tanguille/LLMKube/commit/dad2687ec4b4f0c86407fe58993d8ff5e4374c04))
* **metrics:** publish operator state metrics from observed state ([#1229](https://github.com/Tanguille/LLMKube/issues/1229)) ([5db0915](https://github.com/Tanguille/LLMKube/commit/5db09158d58fd700af6748b1c3198580af264410))
* **metrics:** TTFT histogram, request error counter, vLLM metrics flag ([#409](https://github.com/Tanguille/LLMKube/issues/409)) ([#769](https://github.com/Tanguille/LLMKube/issues/769)) ([563b0c9](https://github.com/Tanguille/LLMKube/commit/563b0c9f96a176f471ca45d4aade64f0aa3022b6))
* **model:** stage multi-file artifacts ([#853](https://github.com/Tanguille/LLMKube/issues/853)) ([ca22b84](https://github.com/Tanguille/LLMKube/commit/ca22b84f508219269d4c6ca3df32b254bf70163c))
* **observability:** per-InferenceService SLO declaration via Pyrra ([#415](https://github.com/Tanguille/LLMKube/issues/415)) ([#1149](https://github.com/Tanguille/LLMKube/issues/1149)) ([4ae022c](https://github.com/Tanguille/LLMKube/commit/4ae022cc862ed0200ba4ea51727324a06fa51166))
* prefetch Model artifacts into the shared cache without an InferenceService ([#1218](https://github.com/Tanguille/LLMKube/issues/1218)) ([7c1161b](https://github.com/Tanguille/LLMKube/commit/7c1161b819eeafebf91140e9b28cee1f594497b8))
* **quota:** add GPUQuota admission decision function ([#1107](https://github.com/Tanguille/LLMKube/issues/1107)) ([4897093](https://github.com/Tanguille/LLMKube/commit/4897093b557b589e0382c40832f0070eb00e2ef5))
* **quota:** VRAM-based GPUQuota accounting from the gpuSharing tier ([#1196](https://github.com/Tanguille/LLMKube/issues/1196) story 4) ([#1200](https://github.com/Tanguille/LLMKube/issues/1200)) ([2c9000c](https://github.com/Tanguille/LLMKube/commit/2c9000cf6e1a55ad4b1e98dde4fb11ba5840f84f))
* **router:** in-memory rolling-window budget accounting engine ([#434](https://github.com/Tanguille/LLMKube/issues/434)) ([#1130](https://github.com/Tanguille/LLMKube/issues/1130)) ([c6ba850](https://github.com/Tanguille/LLMKube/commit/c6ba8504a6135ea457290803c85416994356e0de))
* **router:** optional backend displayName for /v1/models id (Fixes [#792](https://github.com/Tanguille/LLMKube/issues/792)) ([#826](https://github.com/Tanguille/LLMKube/issues/826)) ([7090f83](https://github.com/Tanguille/LLMKube/commit/7090f832557e9c520cb5e3a25a92276f026add2f))
* **router:** Prometheus metrics + OTel spans for routing decisions (Addresses [#433](https://github.com/Tanguille/LLMKube/issues/433)) ([#834](https://github.com/Tanguille/LLMKube/issues/834)) ([b8fa96d](https://github.com/Tanguille/LLMKube/commit/b8fa96d52e5cd73e3d3b9a8dfa210be8b3f5f5dd))
* **router:** TTFT + budget-utilization metrics, backend.provider span attr, Grafana dashboard ([#852](https://github.com/Tanguille/LLMKube/issues/852)) ([b82cde1](https://github.com/Tanguille/LLMKube/commit/b82cde1408adb33843c15f4d6bff7996d91ffcb3))
* **runtime:** add SGLang runtime backend ([#974](https://github.com/Tanguille/LLMKube/issues/974)) ([#1059](https://github.com/Tanguille/LLMKube/issues/1059)) ([9daa186](https://github.com/Tanguille/LLMKube/commit/9daa186ae9ed6ff2b53c8f7d4c193daa19343047))
* **runtime:** Blackwell-ready image pins, NVIDIA llama.cpp divert, runtimeImages overrides, platform floors ([#1197](https://github.com/Tanguille/LLMKube/issues/1197)) ([#1204](https://github.com/Tanguille/LLMKube/issues/1204)) ([9d40b36](https://github.com/Tanguille/LLMKube/commit/9d40b369dd093f8135165e0292ca0c97ab6f16a2))
* **runtime:** close out the SGLang kitchen-sink ([#1060](https://github.com/Tanguille/LLMKube/issues/1060)): minor flags, accept thresholds, typed LoRA adapters, LoRAAdapter CRD ([#1103](https://github.com/Tanguille/LLMKube/issues/1103)) ([8edf8bd](https://github.com/Tanguille/LLMKube/commit/8edf8bdbcb49d7541c187bc750f673dc05581b12))
* scaffold Foreman as an opt-in add-on (M0 + M1) ([#501](https://github.com/Tanguille/LLMKube/issues/501)) ([cd40491](https://github.com/Tanguille/LLMKube/commit/cd404914cc443eab43e16a9dfbf32c47171d2960))
* **scripts:** add foreman-finalize.sh post-GO branch finalizer ([#1126](https://github.com/Tanguille/LLMKube/issues/1126)) ([8d17e25](https://github.com/Tanguille/LLMKube/commit/8d17e251f9babb9534e273e34303a5edf6d1c8a7))
* **selfupdate:** bound download size + GC old agent versions ([#690](https://github.com/Tanguille/LLMKube/issues/690)) ([5205a62](https://github.com/Tanguille/LLMKube/commit/5205a62f5158725816e7a6b0e300aa988b4b6ff2))
* Support pinned multi-file Hugging Face models ([#1110](https://github.com/Tanguille/LLMKube/issues/1110)) ([#1138](https://github.com/Tanguille/LLMKube/issues/1138)) ([e2d3441](https://github.com/Tanguille/LLMKube/commit/e2d34410950d1ec91819bb7049d811f56852a1de))
* **webhook:** admission-time gpuSharing validation ([#1196](https://github.com/Tanguille/LLMKube/issues/1196) story 5) ([#1206](https://github.com/Tanguille/LLMKube/issues/1206)) ([a9de8f7](https://github.com/Tanguille/LLMKube/commit/a9de8f7a9d0d57d7588ae96a830275cbe431e482))
* **webhook:** ModelRouter validating webhook for apply-time honest-boundary rejection ([#708](https://github.com/Tanguille/LLMKube/issues/708)) ([13d9321](https://github.com/Tanguille/LLMKube/commit/13d93216f2c1ed7a6ce6862d359bb367d4f653c2))


### Bug Fixes

* **agent:** inject current date into issue-fix prompt and anchor research queries ([#1202](https://github.com/Tanguille/LLMKube/issues/1202)) ([#1207](https://github.com/Tanguille/LLMKube/issues/1207)) ([5067095](https://github.com/Tanguille/LLMKube/commit/506709596bd2d50c72c3948a33b054cd4de9398e))
* **agent:** retry endpoint registration with correct update semantics ([#664](https://github.com/Tanguille/LLMKube/issues/664)) ([82cfc35](https://github.com/Tanguille/LLMKube/commit/82cfc35894668600162605420c365508d135c49a))
* Available condition reflects Stopped and Suspended phases ([#1273](https://github.com/Tanguille/LLMKube/issues/1273)) ([208bd79](https://github.com/Tanguille/LLMKube/commit/208bd795cd093068efd163ee3d2cd0cd616de79d))
* bump boilerplate copyright year 2025 -&gt; 2026 ([#1162](https://github.com/Tanguille/LLMKube/issues/1162)) ([#1163](https://github.com/Tanguille/LLMKube/issues/1163)) ([30dfaf2](https://github.com/Tanguille/LLMKube/commit/30dfaf22958b8cd2d9aa98a58af4a1bd0d24da09))
* bump Go toolchain to 1.26.4 to patch standard-library CVEs ([#626](https://github.com/Tanguille/LLMKube/issues/626)) ([6d8fbb7](https://github.com/Tanguille/LLMKube/commit/6d8fbb70f0b052b010856dd3ce152fd9a7f271ec))
* cache hf:// multi-file models instead of emptyDir ([#912](https://github.com/Tanguille/LLMKube/issues/912)) ([8e69d74](https://github.com/Tanguille/LLMKube/commit/8e69d74a63d0f3ebb3dec3c4c95214130f9b2580))
* **cachekey:** unify model cache-key derivation across controller and CLI ([#985](https://github.com/Tanguille/LLMKube/issues/985)) ([1fb122c](https://github.com/Tanguille/LLMKube/commit/1fb122c77a88b3acce1e335645354f618ef2ae24))
* **cache:** restore shared model cache as the default (perService becomes opt-in) ([#732](https://github.com/Tanguille/LLMKube/issues/732)) ([44ab7dc](https://github.com/Tanguille/LLMKube/commit/44ab7dc34687e44ca3b0ad9fdc20922b54e5cb86))
* **chart:** disable model cache when modelCache.enabled is false ([#801](https://github.com/Tanguille/LLMKube/issues/801)) ([638663b](https://github.com/Tanguille/LLMKube/commit/638663bb396001d5bcef1529afe3d980fb85b7af))
* **chart:** make PrometheusRule select the chart's own scrape targets ([#1239](https://github.com/Tanguille/LLMKube/issues/1239)) ([ffc697a](https://github.com/Tanguille/LLMKube/commit/ffc697a744898c1513a10d4164f93c393489b28f))
* **chart:** nil-safe gpuSharing navigation in deployment args ([#1209](https://github.com/Tanguille/LLMKube/issues/1209)) ([bbbcdcf](https://github.com/Tanguille/LLMKube/commit/bbbcdcfc43dc859d59f25e4d389a052becf44349))
* **ci:** honor x-kubernetes-preserve-unknown-fields in validate-samples (Fixes [#1085](https://github.com/Tanguille/LLMKube/issues/1085)) ([#1091](https://github.com/Tanguille/LLMKube/issues/1091)) ([5447e88](https://github.com/Tanguille/LLMKube/commit/5447e883983640e6718c6a5bce355e8ea77dd1d4))
* **ci:** pin GitHub Actions to commit SHAs in helm-chart workflow ([#751](https://github.com/Tanguille/LLMKube/issues/751)) ([e1a5b9e](https://github.com/Tanguille/LLMKube/commit/e1a5b9ebc47e0c4118c7a487e1a59f3fbf9739b4))
* **cli:** correct --node-port help text and add NodePort test coverage ([#742](https://github.com/Tanguille/LLMKube/issues/742)) ([ef55900](https://github.com/Tanguille/LLMKube/commit/ef55900d04002fef4999e294919428c62a6caded))
* **cli:** keep the slicer planner output to YAML only (fixes [#1062](https://github.com/Tanguille/LLMKube/issues/1062) regression) ([#1064](https://github.com/Tanguille/LLMKube/issues/1064)) ([5d0eb9c](https://github.com/Tanguille/LLMKube/commit/5d0eb9c67e85450e40c73095d52408f50091f9cd))
* **cli:** scope slicer branch names by run id (Fixes [#1054](https://github.com/Tanguille/LLMKube/issues/1054)) ([#1081](https://github.com/Tanguille/LLMKube/issues/1081)) ([9288401](https://github.com/Tanguille/LLMKube/commit/92884013ebf1140ece46971c960fe27f378025b2))
* **codegen:** regenerate stale committed codegen and widen the sync check ([#1190](https://github.com/Tanguille/LLMKube/issues/1190)) ([aedcb80](https://github.com/Tanguille/LLMKube/commit/aedcb800a65125ea9e93e86c39919316a69991bd))
* **controller:** append TGI extraArgs once, not four times ([#1306](https://github.com/Tanguille/LLMKube/issues/1306)) ([6d675f2](https://github.com/Tanguille/LLMKube/commit/6d675f23f758da6eb6168e1786b5ff07598cbdac))
* **controller:** Available goes False when no replicas are ready ([#1304](https://github.com/Tanguille/LLMKube/issues/1304)) ([f3bd243](https://github.com/Tanguille/LLMKube/commit/f3bd2435f3d43e84ad7cb455df04ee6f89000038))
* **controller:** charge GPUQuota by the resolved GPU count, closing the Model-declared-count bypass ([#1324](https://github.com/Tanguille/LLMKube/issues/1324)) ([e052229](https://github.com/Tanguille/LLMKube/commit/e0522294a8ec499ca10d49f4bb89bebb74ab69fa))
* **controller:** cpu-offload verify advisory, parallelism validation, and a sample that actually runs ([#1321](https://github.com/Tanguille/LLMKube/issues/1321)) ([9740dad](https://github.com/Tanguille/LLMKube/commit/9740dade9e6f5fcaf790ec5c8349f6452ffba260))
* **controller:** default Model accelerator from gpu.runtime (Fixes [#1074](https://github.com/Tanguille/LLMKube/issues/1074)) ([#1087](https://github.com/Tanguille/LLMKube/issues/1087)) ([0390c0f](https://github.com/Tanguille/LLMKube/commit/0390c0f2248b04ab316a7183ad9108936ba819d3))
* **controller:** drop invalid --enable-metrics flag from vLLM runtime ([#1031](https://github.com/Tanguille/LLMKube/issues/1031)) ([9b9450d](https://github.com/Tanguille/LLMKube/commit/9b9450dd2cdaf1df5874209778f11eaf2ba89bbc))
* **controller:** gate HPA scale-up by GPUQuota via maxReplicas accounting ([#1311](https://github.com/Tanguille/LLMKube/issues/1311)) ([#1334](https://github.com/Tanguille/LLMKube/issues/1334)) ([dcefc45](https://github.com/Tanguille/LLMKube/commit/dcefc450049812531e8203334a3dd8939902f25c))
* **controller:** honor GPU resourceName override in checkAcceleratorAvailability ([#747](https://github.com/Tanguille/LLMKube/issues/747)) ([5aa3152](https://github.com/Tanguille/LLMKube/commit/5aa3152b062f9a5b5e459681c46360c295e43a28))
* **controller:** honor RouterRule.Timeout in gateway-mode AIGatewayRoute generation ([#748](https://github.com/Tanguille/LLMKube/issues/748)) ([1978a72](https://github.com/Tanguille/LLMKube/commit/1978a722d81be96b3f6e57bfeb7f41a2792cccf0))
* **controller:** make checkAcceleratorAvailability DRA-aware ([#754](https://github.com/Tanguille/LLMKube/issues/754)) ([#776](https://github.com/Tanguille/LLMKube/issues/776)) ([804063b](https://github.com/Tanguille/LLMKube/commit/804063b8339b74a409fd7ee037390993b8de52a0))
* **controller:** make model cache writable on fsGroupPolicy=None CSIs ([#855](https://github.com/Tanguille/LLMKube/issues/855)) ([#858](https://github.com/Tanguille/LLMKube/issues/858)) ([8e1a30d](https://github.com/Tanguille/LLMKube/commit/8e1a30d1ab3a734c54ca2379ecaaaf431372bc76))
* **controller:** preserve agent-written schedulingStatus on reconcile ([#643](https://github.com/Tanguille/LLMKube/issues/643)) ([#774](https://github.com/Tanguille/LLMKube/issues/774)) ([4321028](https://github.com/Tanguille/LLMKube/commit/4321028391b609cadcad5584d95df304150ec451))
* **controller:** propagate backend displayName into router-proxy config ([#849](https://github.com/Tanguille/LLMKube/issues/849)) ([9f3b360](https://github.com/Tanguille/LLMKube/commit/9f3b360b167034c5a898d1a506674df8ad5bb430))
* **controller:** recognise huggingface.co URL sources as HF repos, not single-file downloads ([#1322](https://github.com/Tanguille/LLMKube/issues/1322)) ([#1325](https://github.com/Tanguille/LLMKube/issues/1325)) ([36fc79f](https://github.com/Tanguille/LLMKube/commit/36fc79f14e40cb9671d2ae8e71cd3012f6c3ffd8))
* **controller:** reconcileService updates existing Service on endpoint changes ([#720](https://github.com/Tanguille/LLMKube/issues/720)) ([#773](https://github.com/Tanguille/LLMKube/issues/773)) ([70222ae](https://github.com/Tanguille/LLMKube/commit/70222aed216b38d042212f1553cac72024f8d48c))
* **controller:** recreate InferenceService Deployment on immutable selector change ([#606](https://github.com/Tanguille/LLMKube/issues/606)) ([#607](https://github.com/Tanguille/LLMKube/issues/607)) ([faf9151](https://github.com/Tanguille/LLMKube/commit/faf915137fe5a5f9b9ec5204c77d1c13b30292a8))
* **controller:** revalidate http/https model sources in init container ([#636](https://github.com/Tanguille/LLMKube/issues/636)) ([64812e5](https://github.com/Tanguille/LLMKube/commit/64812e5a346c02b0a9c4a9581a9c745e505eea81))
* **controller:** revalidate model cache via HEAD + Content-Length, atomic download ([#1309](https://github.com/Tanguille/LLMKube/issues/1309)) ([#1326](https://github.com/Tanguille/LLMKube/issues/1326)) ([3e86988](https://github.com/Tanguille/LLMKube/commit/3e86988d951e825e25d73343c0e4c2f9e16b499a))
* **controller:** run model-cache-prep init as root again (0.8.20 regression) ([#888](https://github.com/Tanguille/LLMKube/issues/888)) ([8e98e50](https://github.com/Tanguille/LLMKube/commit/8e98e500960bdbdf005b61e21ca2396132f1e141))
* **crd:** guard GPU resourceClaims/resourceName CEL rule against absent field ([#753](https://github.com/Tanguille/LLMKube/issues/753)) ([26be1aa](https://github.com/Tanguille/LLMKube/commit/26be1aa3fec2a13fd001098b8df91e1b91716e5d))
* delete GPUQuota metric series when the CR is deleted ([#1230](https://github.com/Tanguille/LLMKube/issues/1230)) ([#1246](https://github.com/Tanguille/LLMKube/issues/1246)) ([1f58c3c](https://github.com/Tanguille/LLMKube/commit/1f58c3c86a03d6486a857cfaa49a8c6572f727c2))
* **deps:** bump golang.org/x/text to v0.39.0 (GO-2026-5970) ([#1192](https://github.com/Tanguille/LLMKube/issues/1192)) ([af5c78e](https://github.com/Tanguille/LLMKube/commit/af5c78ebd8d8ba0fe565182aaaaba6ae08225e39))
* **deps:** bump google.golang.org/grpc to v1.82.1 (GHSA-hrxh-6v49-42gf) ([#1212](https://github.com/Tanguille/LLMKube/issues/1212)) ([188d8eb](https://github.com/Tanguille/LLMKube/commit/188d8eb04e08fd7f608c54b683e8bcbdd3cb74b3))
* derive BTP perRetry timeout from configured router timeout (Fixes [#817](https://github.com/Tanguille/LLMKube/issues/817)) ([#818](https://github.com/Tanguille/LLMKube/issues/818)) ([5c41d1e](https://github.com/Tanguille/LLMKube/commit/5c41d1e42406df3c3942cb8697e67a7be7ae6b32))
* disable llama.cpp prompt cache in benchmark requests ([#1272](https://github.com/Tanguille/LLMKube/issues/1272)) ([eaa61ad](https://github.com/Tanguille/LLMKube/commit/eaa61ad79607e5d239a63fac728a4962b324cb98))
* **foreman/build:** include gate_job_template.yaml in Docker context ([#554](https://github.com/Tanguille/LLMKube/issues/554)) ([def535d](https://github.com/Tanguille/LLMKube/commit/def535d3da8e28fa6d9eeba798d1885a182d176c))
* **foreman/executor:** map reasoning-only exhaustion to INCOMPLETE ([#652](https://github.com/Tanguille/LLMKube/issues/652)) ([d2f453e](https://github.com/Tanguille/LLMKube/commit/d2f453ea8e2fab9aff94590d7937623b85c94a0a))
* **foreman/executor:** resolve InferenceService port from live Endpoints, not stale install-time override ([#550](https://github.com/Tanguille/LLMKube/issues/550)) ([4351608](https://github.com/Tanguille/LLMKube/commit/43516088c7cd3af704e51e411b9e3bd657fd307c))
* **foreman/executor:** route reviewer-role GO through modelDecidedResult ([#545](https://github.com/Tanguille/LLMKube/issues/545)) ([16943a5](https://github.com/Tanguille/LLMKube/commit/16943a5814eeeb7bac897b2e816cea51f4004bc2))
* **foreman/loop:** force-terminate returns clean Terminal envelope ([#544](https://github.com/Tanguille/LLMKube/issues/544) follow-up) ([#570](https://github.com/Tanguille/LLMKube/issues/570)) ([19500c9](https://github.com/Tanguille/LLMKube/commit/19500c9a36fb87d390eab93204ca6a69499705a6))
* **foreman/loop:** keep wire-stripped reasoning-only turns template-valid ([#653](https://github.com/Tanguille/LLMKube/issues/653)) ([5ec14f6](https://github.com/Tanguille/LLMKube/commit/5ec14f6fac87c708bf8fb94c33f96862c8740da7))
* **foreman/m4:** gate Job honors payload.branch + clones from --git-remote-url ([#529](https://github.com/Tanguille/LLMKube/issues/529)) ([905a269](https://github.com/Tanguille/LLMKube/commit/905a2698a922641a8cd64ce6bd81e18ff7ecb339))
* **foreman/oai:** always emit content on non-assistant messages ([#562](https://github.com/Tanguille/LLMKube/issues/562)) ([f6dc8e1](https://github.com/Tanguille/LLMKube/commit/f6dc8e16f734808baa441540fa5e26f402c947bf))
* **foreman/reviewer:** ground-truth filesTouched + bump qwen maxTurns + tighten confabulation defenses ([#584](https://github.com/Tanguille/LLMKube/issues/584)) ([b3e21f0](https://github.com/Tanguille/LLMKube/commit/b3e21f096fd61be674dc10b7843a56898a6e094a))
* **foreman/reviewer:** ground-truth issueAsk + cap qwen Section D ([#587](https://github.com/Tanguille/LLMKube/issues/587)) ([b66006c](https://github.com/Tanguille/LLMKube/commit/b66006c8234b867fa60edbea0cc75004abcf00eb))
* **foreman/reviewer:** role-aware stuck-loop detector + non-empty reviewer user prompt (rerun-7 follow-up) ([#577](https://github.com/Tanguille/LLMKube/issues/577)) ([19590f6](https://github.com/Tanguille/LLMKube/commit/19590f64c08522fb1d924e23cb934fd47e376783))
* **foreman/tools:** cmd.WaitDelay + process-group kill so BashTool can't deadlock on grandchild-held pipes ([#547](https://github.com/Tanguille/LLMKube/issues/547)) ([c12f6f8](https://github.com/Tanguille/LLMKube/commit/c12f6f82674f5167fbc6022315c4b2530d3c7106))
* **foreman:** abort orphaned agent loop when its AgenticTask is deleted (Fixes [#1136](https://github.com/Tanguille/LLMKube/issues/1136)) ([#1140](https://github.com/Tanguille/LLMKube/issues/1140)) ([471a00c](https://github.com/Tanguille/LLMKube/commit/471a00c4811405fc251b9bd69a927d3e1c817637))
* **foreman:** accept multi-segment repo slugs (GitLab subgroups, nested Forgejo orgs) ([#1299](https://github.com/Tanguille/LLMKube/issues/1299)) ([#1341](https://github.com/Tanguille/LLMKube/issues/1341)) ([1b7c47a](https://github.com/Tanguille/LLMKube/commit/1b7c47ae63828bea4ab93038dcf65785c2a1a346))
* **foreman:** accept workspace-internal absolute paths in resolveInside ([#957](https://github.com/Tanguille/LLMKube/issues/957)) ([34b126c](https://github.com/Tanguille/LLMKube/commit/34b126c27465471bac0b89c9f9f32824e56aa0c4))
* **foreman:** add payload.branchStrategy to stop stale revisions reverting merged work ([#1042](https://github.com/Tanguille/LLMKube/issues/1042)) ([9f806d4](https://github.com/Tanguille/LLMKube/commit/9f806d476befe91d10afda0d682115720d6abc55))
* **foreman:** agent claims tasks depth-first so verify/review don't starve ([#947](https://github.com/Tanguille/LLMKube/issues/947)) ([323423d](https://github.com/Tanguille/LLMKube/commit/323423d51f5d53d5988c7e50e746c4582b06b630))
* **foreman:** anchor recovery soft-reset at merge-base branch point ([#1044](https://github.com/Tanguille/LLMKube/issues/1044)) ([2492d15](https://github.com/Tanguille/LLMKube/commit/2492d15b1b7f8245f043bf22dbd62c52f3b5ad53))
* **foreman:** apply the empty-assistant guard to the preserved truncated turn ([#1282](https://github.com/Tanguille/LLMKube/issues/1282)) ([b1f51cc](https://github.com/Tanguille/LLMKube/commit/b1f51cc181d4028c1a2effc4f95bb4fb28ec6900))
* **foreman:** auto-apply gofmt in the coder gate instead of failing the coder ([#1327](https://github.com/Tanguille/LLMKube/issues/1327)) ([#1333](https://github.com/Tanguille/LLMKube/issues/1333)) ([954c67b](https://github.com/Tanguille/LLMKube/commit/954c67bd56764436727036e00446fe4969b0e8ec))
* **foreman:** bound reasoning-model coder turns with a per-turn token budget ([#1175](https://github.com/Tanguille/LLMKube/issues/1175)) ([5100c11](https://github.com/Tanguille/LLMKube/commit/5100c112873211b880bc208897864ba8d42fdcec))
* **foreman:** cascade + Workload rollup gate on phase AND verdict, not phase alone ([#548](https://github.com/Tanguille/LLMKube/issues/548)) ([1b72a7c](https://github.com/Tanguille/LLMKube/commit/1b72a7c9d4d5545eab74a2a15b2422335cd9ead4))
* **foreman:** chart exposes --foreman-namespace so gate Jobs land with the cache PVC ([#939](https://github.com/Tanguille/LLMKube/issues/939)) ([0a9ff11](https://github.com/Tanguille/LLMKube/commit/0a9ff11bd870099d5ed12e38e3adcb2176ea9635))
* **foreman:** chart wires --workspace-dir + tightens docs for native-mode required values ([#534](https://github.com/Tanguille/LLMKube/issues/534)) ([1c43c69](https://github.com/Tanguille/LLMKube/commit/1c43c69fa257ae1d2cb8aecada54831e815e2780))
* **foreman:** count identical read_file re-reads as no-progress under the edit-free nudge ([#1179](https://github.com/Tanguille/LLMKube/issues/1179)) ([2fad7ec](https://github.com/Tanguille/LLMKube/commit/2fad7ecb7edb12d2ed23a588377908cd53af7790))
* **foreman:** default to rebase when reviseFromBranch is set without branchStrategy ([#1065](https://github.com/Tanguille/LLMKube/issues/1065)) ([2792634](https://github.com/Tanguille/LLMKube/commit/27926347e67f4042f0b73f6f7452ac4318ce0c1d))
* **foreman:** defer generic self-gate when runtime is missing from coder image ([#958](https://github.com/Tanguille/LLMKube/issues/958)) ([df185ec](https://github.com/Tanguille/LLMKube/commit/df185ec9d3538c9e524fbc54d5fbef2ecbaaf2e9))
* **foreman:** detect stale FleetNodes via heartbeat window ([#633](https://github.com/Tanguille/LLMKube/issues/633)) ([515bdfe](https://github.com/Tanguille/LLMKube/commit/515bdfeedcdf130ff216d8fb7e573f4a8a3c453f))
* **foreman:** do not downgrade a mixed footprint whose classes are all self-GO ([#1342](https://github.com/Tanguille/LLMKube/issues/1342)) ([#1344](https://github.com/Tanguille/LLMKube/issues/1344)) ([d7c6569](https://github.com/Tanguille/LLMKube/commit/d7c656968064c5c9c3c6390c720f9e60a746a073))
* **foreman:** do not resynthesize children on a terminating Workload ([#950](https://github.com/Tanguille/LLMKube/issues/950)) ([f90cc49](https://github.com/Tanguille/LLMKube/commit/f90cc49c55961c90d1aaaa7e1e1b375258bec07d))
* **foreman:** don't force-terminate a coder mid-verification after it has edited ([#896](https://github.com/Tanguille/LLMKube/issues/896)) ([#898](https://github.com/Tanguille/LLMKube/issues/898)) ([b097c29](https://github.com/Tanguille/LLMKube/commit/b097c29963ec1c1588ac53b0ca7e4ce477630566))
* **foreman:** drop chart-level subchart dep on llmkube (unblock v0.7.11 chart-releaser) ([#519](https://github.com/Tanguille/LLMKube/issues/519)) ([207ddc6](https://github.com/Tanguille/LLMKube/commit/207ddc64f82e0243da96bdd73e1b5d949f991041))
* **foreman:** drop deprecated Result.Requeue in workload terminal test ([#688](https://github.com/Tanguille/LLMKube/issues/688)) ([a97056c](https://github.com/Tanguille/LLMKube/commit/a97056c89c27a14cd2fde0a63f2d4c49ce7c086b))
* **foreman:** edits disarm a nudged RepeatedToolCall hash ([#1215](https://github.com/Tanguille/LLMKube/issues/1215)) ([#1216](https://github.com/Tanguille/LLMKube/issues/1216)) ([60df2ad](https://github.com/Tanguille/LLMKube/commit/60df2ade6879cc5d154ade41185de7b1a51e992d))
* **foreman:** ERROR verdicts become terminal INCOMPLETE outcomes; watcher can no longer wedge ([#667](https://github.com/Tanguille/LLMKube/issues/667)) ([46405b6](https://github.com/Tanguille/LLMKube/commit/46405b67ea7646f367feb2bbd143e13f13b6b80e))
* **foreman:** exempt REJECT from grounded-finding demotion ([#1008](https://github.com/Tanguille/LLMKube/issues/1008)) ([18098cb](https://github.com/Tanguille/LLMKube/commit/18098cb3b98d4a947da8ffc76b03ac706fa8d832))
* **foreman:** expire stale claims so tasks survive agent death ([#669](https://github.com/Tanguille/LLMKube/issues/669)) ([8af7ac6](https://github.com/Tanguille/LLMKube/commit/8af7ac65e477967ff5f4f742409e3c434c5bfc7f))
* **foreman:** gate Job downloads the go.mod toolchain (GOTOOLCHAIN=auto) ([#1019](https://github.com/Tanguille/LLMKube/issues/1019)) ([5f4c51c](https://github.com/Tanguille/LLMKube/commit/5f4c51cf04d1755dcf666c35ae35d03fe5b57f53))
* **foreman:** grant coder Job pods get on secrets for cloud-proxy auth ([#987](https://github.com/Tanguille/LLMKube/issues/987)) ([ffe45d7](https://github.com/Tanguille/LLMKube/commit/ffe45d7e661d4a02a3525a8b20564eff0b472fb3))
* **foreman:** guard file-less findings + resolve bare/absolute paths in grounding rail ([#1009](https://github.com/Tanguille/LLMKube/issues/1009)) ([304a2b8](https://github.com/Tanguille/LLMKube/commit/304a2b851e7ae1135ecc9ca5dc2ff1627696917f))
* **foreman:** harden the agent loop against false-negative INCOMPLETE terminations ([#623](https://github.com/Tanguille/LLMKube/issues/623)) ([edc93e4](https://github.com/Tanguille/LLMKube/commit/edc93e404c874da1e14811bed6b72ba7722b01d3))
* **foreman:** hold the session compaction drop point steady across turns ([#1287](https://github.com/Tanguille/LLMKube/issues/1287)) ([febcb2a](https://github.com/Tanguille/LLMKube/commit/febcb2a75945471167231b7e9e3b1daf6bd10163))
* **foreman:** honor GateProfile source extensions in scope-overlap issue-ref extraction ([#1120](https://github.com/Tanguille/LLMKube/issues/1120)) ([0c20431](https://github.com/Tanguille/LLMKube/commit/0c20431fe280c56d542c17cf101fa5a168d1145d))
* **foreman:** inject Workload.spec.intent into coder prompts ([#1201](https://github.com/Tanguille/LLMKube/issues/1201)) ([#1203](https://github.com/Tanguille/LLMKube/issues/1203)) ([9a8371c](https://github.com/Tanguille/LLMKube/commit/9a8371c41d8fd72de9a77768c1b84c5d7d213de9))
* **foreman:** key test-presence gate on net-new functions only ([#983](https://github.com/Tanguille/LLMKube/issues/983)) ([0236630](https://github.com/Tanguille/LLMKube/commit/0236630ec16cbb9ef6108adfc443e405834ea348))
* **foreman:** make coder self-gate diff-aware, skip Go tier on non-Go diffs ([#1292](https://github.com/Tanguille/LLMKube/issues/1292)) ([#1336](https://github.com/Tanguille/LLMKube/issues/1336)) ([9f4acef](https://github.com/Tanguille/LLMKube/commit/9f4acef6a39742894f0ba434d48c3e116b02bc50))
* **foreman:** make install-foreman-agent produce a working plist ([#743](https://github.com/Tanguille/LLMKube/issues/743)) ([b946fef](https://github.com/Tanguille/LLMKube/commit/b946fef0e7c4c910554f5459ccf7308c1eaa9600))
* **foreman:** make the verify-gate bite check actually run, enable by default ([#805](https://github.com/Tanguille/LLMKube/issues/805)) ([acbe631](https://github.com/Tanguille/LLMKube/commit/acbe631b5ba28982ba6e08a526cfe64c53095797))
* **foreman:** ParseRepo delegates to the shared codehost slug validator ([#1343](https://github.com/Tanguille/LLMKube/issues/1343)) ([#1345](https://github.com/Tanguille/LLMKube/issues/1345)) ([ae2dfc2](https://github.com/Tanguille/LLMKube/commit/ae2dfc2ed7f2d130a12d9e6364f5e7ed03f70f11))
* **foreman:** patchTerminal stands down when the task is no longer owned ([#670](https://github.com/Tanguille/LLMKube/issues/670)) ([33af907](https://github.com/Tanguille/LLMKube/commit/33af90773dc2afe7f4a581274874f33ce4e268c7))
* **foreman:** populate FleetNode.Status.CurrentTask so the scheduler spreads work ([#978](https://github.com/Tanguille/LLMKube/issues/978)) ([d731a90](https://github.com/Tanguille/LLMKube/commit/d731a9020c5f01cc7a03d2ff562549731c8a08d9))
* **foreman:** preserve the in-pod outcome envelope across the coder Job hop ([#1077](https://github.com/Tanguille/LLMKube/issues/1077)) ([#1210](https://github.com/Tanguille/LLMKube/issues/1210)) ([6ed7edf](https://github.com/Tanguille/LLMKube/commit/6ed7edf1a4bd54ea2aaf88b6e7fec3051ab88fa3))
* **foreman:** propagate Job-mode branch + commit SHA to AgenticTask status ([#634](https://github.com/Tanguille/LLMKube/issues/634)) ([3586a14](https://github.com/Tanguille/LLMKube/commit/3586a14154187cf718c2bcc7b44c069e84b44d6f))
* **foreman:** raise coder agent memory limit default to 8Gi ([#884](https://github.com/Tanguille/LLMKube/issues/884)) ([8b3ee32](https://github.com/Tanguille/LLMKube/commit/8b3ee321fb12597394782e1691989d84f05bd625))
* **foreman:** reap audit ConfigMaps older than retention ([#990](https://github.com/Tanguille/LLMKube/issues/990)) ([#1027](https://github.com/Tanguille/LLMKube/issues/1027)) ([08d06d6](https://github.com/Tanguille/LLMKube/commit/08d06d6bd3595af114cc21ae9c492202c1184893))
* **foreman:** reap orphaned Draining FleetNodes so they stop leaking ([#980](https://github.com/Tanguille/LLMKube/issues/980)) ([241ac4a](https://github.com/Tanguille/LLMKube/commit/241ac4a036a9338203691f6789eeddb0cab1171b))
* **foreman:** record IsError on MCP transport failures ([#1330](https://github.com/Tanguille/LLMKube/issues/1330)) ([#1335](https://github.com/Tanguille/LLMKube/issues/1335)) ([c42f873](https://github.com/Tanguille/LLMKube/commit/c42f87316e667c80753401089ad20a00f1150214))
* **foreman:** recover orphaned phase=Running tasks on agent restart ([#542](https://github.com/Tanguille/LLMKube/issues/542)) ([#598](https://github.com/Tanguille/LLMKube/issues/598)) ([6dd2c44](https://github.com/Tanguille/LLMKube/commit/6dd2c445fbec7d85b32dec67169de8339b6ec0e5))
* **foreman:** recover str_replace from near-miss old_string ([#917](https://github.com/Tanguille/LLMKube/issues/917)) ([4ce29e8](https://github.com/Tanguille/LLMKube/commit/4ce29e85f8c3945d17acb50e3b140225b0fe3863))
* **foreman:** reject no-op str_replace where old_string equals new_string ([#969](https://github.com/Tanguille/LLMKube/issues/969)) ([c71f38b](https://github.com/Tanguille/LLMKube/commit/c71f38b2d0818e26311dbfed39204195adbcd60d))
* **foreman:** replace stale agent-owned branches on push rejection (force-with-lease) ([#948](https://github.com/Tanguille/LLMKube/issues/948)) ([c55c6ce](https://github.com/Tanguille/LLMKube/commit/c55c6cea3b962a610490565ac9ab010e61761548))
* **foreman:** retry transient SSE/transport errors in the OAI client ([#815](https://github.com/Tanguille/LLMKube/issues/815)) ([#816](https://github.com/Tanguille/LLMKube/issues/816)) ([1bf8d3d](https://github.com/Tanguille/LLMKube/commit/1bf8d3dabcfee3d78d2d19cae19bf3cac84f233f))
* **foreman:** reviewer diffs against the upstream base, not stale local fork main ([#1006](https://github.com/Tanguille/LLMKube/issues/1006)) ([6ef7278](https://github.com/Tanguille/LLMKube/commit/6ef72781ad1f74e4f703a53b57df46dde5ee9d09))
* **foreman:** scope coder-gate golangci-lint cache per workspace ([#760](https://github.com/Tanguille/LLMKube/issues/760)) ([cee04e8](https://github.com/Tanguille/LLMKube/commit/cee04e8d58b4e0a6cb5c548313c07c36cb7d6050))
* **foreman:** scope guard skips check on zero-Go-file diffs; NUL-safe git status (Fixes [#800](https://github.com/Tanguille/LLMKube/issues/800)) ([#823](https://github.com/Tanguille/LLMKube/issues/823)) ([92e5501](https://github.com/Tanguille/LLMKube/commit/92e5501b0faaf85d348f7dcfcb2bab17f5269e4e))
* **foreman:** scope-overlap check catches Go files in new directories ([#962](https://github.com/Tanguille/LLMKube/issues/962)) ([486a944](https://github.com/Tanguille/LLMKube/commit/486a944cb4630a8da1fe6126ed267469ab271bbf))
* **foreman:** scope-overlap rail rescues honest paraphrase from false NO-GO ([#746](https://github.com/Tanguille/LLMKube/issues/746)) ([00ae36e](https://github.com/Tanguille/LLMKube/commit/00ae36e813f625b041f57c8c8a9ee90798a12d31))
* **foreman:** set fsGroup on the gate pod so non-root gates can write XDG_DATA_HOME ([#1068](https://github.com/Tanguille/LLMKube/issues/1068)) ([7465e2b](https://github.com/Tanguille/LLMKube/commit/7465e2bbb0764ad3ff2d5f12a7cce3db3202ea32))
* **foreman:** split git committer identity from author for human DCO sign-off ([#1323](https://github.com/Tanguille/LLMKube/issues/1323)) ([44ef09f](https://github.com/Tanguille/LLMKube/commit/44ef09fddeaa5d89200ad145f4d2c592dcdb2f10))
* **foreman:** split per-turn timeout from loop-wide budget ([#532](https://github.com/Tanguille/LLMKube/issues/532)) ([#602](https://github.com/Tanguille/LLMKube/issues/602)) ([41e7663](https://github.com/Tanguille/LLMKube/commit/41e7663cb25a64a967feb56ec9de49be4ca98c9c))
* **foreman:** stamp real AgenticTask name on the post-push gate Job (not 'unknown') ([#894](https://github.com/Tanguille/LLMKube/issues/894)) ([f8096d4](https://github.com/Tanguille/LLMKube/commit/f8096d465ee030b3685cefc9563bdf5e04bb10ac))
* **foreman:** stop the coder from running envtest it cannot run ([#1070](https://github.com/Tanguille/LLMKube/issues/1070)) ([bf203fe](https://github.com/Tanguille/LLMKube/commit/bf203fe04ba3452b5ffc167cbab3b4578a09c5d6))
* **foreman:** substitute placeholder for empty assistant replies to avoid poisoning history ([#940](https://github.com/Tanguille/LLMKube/issues/940)) ([6eb67f3](https://github.com/Tanguille/LLMKube/commit/6eb67f38cc1486fbe3034006f34bde4a8c9d6993))
* **foreman:** test-presence accepts behavioral coverage of unexported helpers ([#1329](https://github.com/Tanguille/LLMKube/issues/1329)) ([#1340](https://github.com/Tanguille/LLMKube/issues/1340)) ([f1aea17](https://github.com/Tanguille/LLMKube/commit/f1aea178e3d05487f4dee5e42202b8ce555cb448))
* **foreman:** three first-run failures on a clean cluster ([#1295](https://github.com/Tanguille/LLMKube/issues/1295)) ([5ca3e64](https://github.com/Tanguille/LLMKube/commit/5ca3e64d26647501db0c104b26918c5b6a8a2f97))
* **foreman:** tolerate self-committed model work and detect git apply edits ([#995](https://github.com/Tanguille/LLMKube/issues/995)) ([730d1cd](https://github.com/Tanguille/LLMKube/commit/730d1cd17c4d2fa4c9ec39e3eeaf86fecafb9b3c))
* **foreman:** truncate over-length submit_result summaries instead of rejecting ([#999](https://github.com/Tanguille/LLMKube/issues/999)) ([8c36edd](https://github.com/Tanguille/LLMKube/commit/8c36edd734ed200bbee6bb89f7fe7c03ff56e527))
* **foreman:** warm-path reviewer scheduling on macOS ([#578](https://github.com/Tanguille/LLMKube/issues/578), [#579](https://github.com/Tanguille/LLMKube/issues/579)) ([#597](https://github.com/Tanguille/LLMKube/issues/597)) ([a94d1ef](https://github.com/Tanguille/LLMKube/commit/a94d1efec9cb796a4e985eb92964925182a20ac0))
* **foreman:** warn when an MCP allowlist entry matches no server tool ([#1184](https://github.com/Tanguille/LLMKube/issues/1184)) ([0664814](https://github.com/Tanguille/LLMKube/commit/0664814236b24448b74802cb7935ae0298100f86))
* **foreman:** widen coder scope-overlap gate to a bottom-quartile floor ([#1181](https://github.com/Tanguille/LLMKube/issues/1181)) ([f07cba4](https://github.com/Tanguille/LLMKube/commit/f07cba4c9aed5761a5c3a810437d1688744db241))
* **foreman:** workspace reset survives read-only files from prior runs ([#671](https://github.com/Tanguille/LLMKube/issues/671)) ([0a7de0d](https://github.com/Tanguille/LLMKube/commit/0a7de0d1058f88a704fbb3ea28118d48e8db2345))
* gate bite check reverts to the upstream merge-base, never the fork tip ([#1260](https://github.com/Tanguille/LLMKube/issues/1260)) ([8a6928f](https://github.com/Tanguille/LLMKube/commit/8a6928ffc08ee64d126129bf12cd722b01b55080))
* **gate:** check non-Go changes against the shared merge-base, not HEAD~1 ([#1284](https://github.com/Tanguille/LLMKube/issues/1284)) ([6940033](https://github.com/Tanguille/LLMKube/commit/6940033fc9eb6b8448a7cc09919eff695428bb9e))
* **grafana:** delete dashboard panels for metrics nothing emits ([#1244](https://github.com/Tanguille/LLMKube/issues/1244)) ([9c586d9](https://github.com/Tanguille/LLMKube/commit/9c586d9458fa85a338d0fc316e1270b4bbc9e00b))
* grant events.k8s.io to the operator event recorder ([#914](https://github.com/Tanguille/LLMKube/issues/914)) ([5b23c4b](https://github.com/Tanguille/LLMKube/commit/5b23c4bc2b1ce77271f42456e2c90afb78d2b655))
* **inference:** warn when modelCache.claimName is silently ignored ([#966](https://github.com/Tanguille/LLMKube/issues/966)) ([d49cd22](https://github.com/Tanguille/LLMKube/commit/d49cd2202a74d92de3d188c7439b1d69d69362ad))
* **metal-agent:** clear SchedulingStatus on memory-check-pass ([#777](https://github.com/Tanguille/LLMKube/issues/777)) ([#779](https://github.com/Tanguille/LLMKube/issues/779)) ([ed1c4eb](https://github.com/Tanguille/LLMKube/commit/ed1c4eb2dc4012d56440c8225cff950f0055d7f4))
* **metal-agent:** fail closed when memory admission check cannot complete ([#641](https://github.com/Tanguille/LLMKube/issues/641)) ([cfe53aa](https://github.com/Tanguille/LLMKube/commit/cfe53aa0282bc0e38f6a34dd7caeaa71de1b794e))
* **metal-agent:** prefer routable interface for host-IP auto-detect ([#526](https://github.com/Tanguille/LLMKube/issues/526)) ([#599](https://github.com/Tanguille/LLMKube/issues/599)) ([c780795](https://github.com/Tanguille/LLMKube/commit/c78079503529538abf0c05aa283957b4e6b8d29a))
* **metal-agent:** prevent zero-byte stub files from failed model downloads ([#642](https://github.com/Tanguille/LLMKube/issues/642)) ([#772](https://github.com/Tanguille/LLMKube/issues/772)) ([d737e47](https://github.com/Tanguille/LLMKube/commit/d737e47677798311754e56119e4ef570778e573e))
* **metal-agent:** reap orphaned legacy Endpoints so mirror slices stop blackholing traffic ([#895](https://github.com/Tanguille/LLMKube/issues/895)) ([6274fc5](https://github.com/Tanguille/LLMKube/commit/6274fc5135c44eb635f0cd6289a3fd10dcdb1d2d))
* **metal-agent:** register llamacpp runtime alias for llama.cpp executor ([#785](https://github.com/Tanguille/LLMKube/issues/785)) ([73b7c90](https://github.com/Tanguille/LLMKube/commit/73b7c90575affde62f7564e28e97699e1ff556a1))
* metal-path InferenceService status and memory pre-flight ([#488](https://github.com/Tanguille/LLMKube/issues/488)) ([98ef2c4](https://github.com/Tanguille/LLMKube/commit/98ef2c4fb42e0d4aa248a8c77f6c09ae8c1058ac))
* **metrics:** remove dead metrics + phantom PrometheusRule error-rate rule ([#1010](https://github.com/Tanguille/LLMKube/issues/1010)) ([7c92f3f](https://github.com/Tanguille/LLMKube/commit/7c92f3fa6d1b6f9a7b9f1ea8a9e13efe9d77262a))
* **metrics:** remove inert InferenceTTFT and InferenceRequestErrors metrics ([#786](https://github.com/Tanguille/LLMKube/issues/786)) ([#810](https://github.com/Tanguille/LLMKube/issues/810)) ([9e42217](https://github.com/Tanguille/LLMKube/commit/9e42217fe612946c6479d90988b7909c69f1dfaf))
* **metrics:** report GPU queue depth per namespace ([#1243](https://github.com/Tanguille/LLMKube/issues/1243)) ([5779c05](https://github.com/Tanguille/LLMKube/commit/5779c05e7dfd98d5f24acc2cbfab44301c08b0b4))
* per-node model cache so GPU on a second node can schedule ([#728](https://github.com/Tanguille/LLMKube/issues/728)) ([#729](https://github.com/Tanguille/LLMKube/issues/729)) ([79bccce](https://github.com/Tanguille/LLMKube/commit/79bccce3b4445914d7d62b43c2cad0115e310d0d))
* preserve init-container SecurityContext in podTemplatesDiffer ([#922](https://github.com/Tanguille/LLMKube/issues/922)) ([#923](https://github.com/Tanguille/LLMKube/issues/923)) ([859841e](https://github.com/Tanguille/LLMKube/commit/859841e7026c7c65ef850af89a3639851c2ca98b))
* recycle inference pods without invalid deadlines ([#1232](https://github.com/Tanguille/LLMKube/issues/1232)) ([0b716d7](https://github.com/Tanguille/LLMKube/commit/0b716d7510cc9bfb172e37f5b6c1c3075a32c524))
* **release:** publish a cross-platform Homebrew formula, not a macOS-only cask ([#1041](https://github.com/Tanguille/LLMKube/issues/1041)) ([32dcfea](https://github.com/Tanguille/LLMKube/commit/32dcfea7d90c73d1cf333bafe61a1bac0abd6fcf))
* report Stopped phase when InferenceService.spec.replicas=0 on Metal path ([#498](https://github.com/Tanguille/LLMKube/issues/498)) ([7787239](https://github.com/Tanguille/LLMKube/commit/77872395deda1ec5ce89d61c12de62cedd998968))
* **router:** inject backend Model on dispatch so fallback chains degrade ([#766](https://github.com/Tanguille/LLMKube/issues/766)) ([bee7f1c](https://github.com/Tanguille/LLMKube/commit/bee7f1cf6f31526dca957937e69dcb1749715736))
* **runtime:** bind inference servers to :: for IPv6-only clusters ([#973](https://github.com/Tanguille/LLMKube/issues/973)) ([398d5c1](https://github.com/Tanguille/LLMKube/commit/398d5c1582266cae66f50e5bbd4e5df84023e361))
* **scripts:** foreman-finalize handles Foreman CRDs, clean-tree, and title override ([#1131](https://github.com/Tanguille/LLMKube/issues/1131)) ([db3eeaf](https://github.com/Tanguille/LLMKube/commit/db3eeafb3b5933591f7a796a99a41bb020cce77a))
* **security:** gate local/hostPath model sources + block controller SSRF (GHSA-jw3m-8q7m-f35r) ([#981](https://github.com/Tanguille/LLMKube/issues/981)) ([ec2647f](https://github.com/Tanguille/LLMKube/commit/ec2647fd4557962a971a1bc9435790b8e77ce961))
* **selfupdate:** resolve current symlink in managed-root detection ([#679](https://github.com/Tanguille/LLMKube/issues/679)) ([a6e7223](https://github.com/Tanguille/LLMKube/commit/a6e7223fabd5ee15fdf5905f803cfc90498734b1))
* skip GitHub auth and repo clone for freeform tasks without a repo ([#1350](https://github.com/Tanguille/LLMKube/issues/1350)) ([c1d0cc1](https://github.com/Tanguille/LLMKube/commit/c1d0cc1611c87ee040453e32cf13a6cce800577c))
* **slicer:** give the union commit an explicit git identity ([#1057](https://github.com/Tanguille/LLMKube/issues/1057)) ([15d906f](https://github.com/Tanguille/LLMKube/commit/15d906fe58b6edeb69837833ab7927add3ae69cd))
* **slicer:** reject trailing-underscore pins at plan validation (Fixes [#1058](https://github.com/Tanguille/LLMKube/issues/1058)) ([#1082](https://github.com/Tanguille/LLMKube/issues/1082)) ([d4118d3](https://github.com/Tanguille/LLMKube/commit/d4118d3e090d243fe49e7be9f373468d02a08de8))
* **slicer:** surface pinned-prefix drift (Fixes [#1084](https://github.com/Tanguille/LLMKube/issues/1084)) ([#1089](https://github.com/Tanguille/LLMKube/issues/1089)) ([0f6edd2](https://github.com/Tanguille/LLMKube/commit/0f6edd23b9852f0abdb08105ac80f8fdb4ac711c))
* **spine-probes:** restore --max-tokens and the 'none' ablation arm ([#1278](https://github.com/Tanguille/LLMKube/issues/1278)) ([9493201](https://github.com/Tanguille/LLMKube/commit/94932012939c5ea9bba404faae5e7da2609a0150))
* stop the operator fighting the HPA over Deployment replicas ([#485](https://github.com/Tanguille/LLMKube/issues/485)) ([8fc70e2](https://github.com/Tanguille/LLMKube/commit/8fc70e23cb6a8b699c7d853cf109d1e55561d6eb))
* stop wasted-turn context ballooning on max_tokens truncation ([#1352](https://github.com/Tanguille/LLMKube/issues/1352)) ([eaac3ef](https://github.com/Tanguille/LLMKube/commit/eaac3efbe1a8b1b290f7c828cdf8776ebcdf128d))
* waitForIdle proceeds past crashlooping pods; truthful deferral reason on mixed state ([#1250](https://github.com/Tanguille/LLMKube/issues/1250)) ([#1262](https://github.com/Tanguille/LLMKube/issues/1262)) ([88c87f9](https://github.com/Tanguille/LLMKube/commit/88c87f9770f7e1c2d5026e52c768841a35e07b8c))
* **webhook:** serve GPUQuota webhook at its configured path, with e2e coverage ([#416](https://github.com/Tanguille/LLMKube/issues/416)) ([#1195](https://github.com/Tanguille/LLMKube/issues/1195)) ([b377f52](https://github.com/Tanguille/LLMKube/commit/b377f52e88aa919ca379e3b29d7e34bc1ef22725))


### Documentation

* add AGENTS.md ([#496](https://github.com/Tanguille/LLMKube/issues/496)) ([89d3766](https://github.com/Tanguille/LLMKube/commit/89d3766ba5a43726fdf89b0fbe61caf7bacb75dc))
* add AI-assisted contribution policy ([#872](https://github.com/Tanguille/LLMKube/issues/872)) ([e65f2fa](https://github.com/Tanguille/LLMKube/commit/e65f2fa90f88982390e83e905b123a9d7e114579))
* add Jory Irving as Foreman area maintainer ([#926](https://github.com/Tanguille/LLMKube/issues/926)) ([7513176](https://github.com/Tanguille/LLMKube/commit/751317688dae26eb01b6931d648c23bb05169fe5))
* add Strix Halo node onboarding quickstart ([#724](https://github.com/Tanguille/LLMKube/issues/724)) ([b1859f0](https://github.com/Tanguille/LLMKube/commit/b1859f0e4f87d84eb3d9c79233b1aea45a24a3f7))
* **api:** correct MemoryLimitGiB doc, it is quota-accounting only with no runtime enforcement ([#1312](https://github.com/Tanguille/LLMKube/issues/1312)) ([#1339](https://github.com/Tanguille/LLMKube/issues/1339)) ([90e6ca3](https://github.com/Tanguille/LLMKube/commit/90e6ca38228f89e6818db8bb0b5312409ed8637a))
* **api:** stop the GPU-memory fields implying enforcement that does not exist ([#1314](https://github.com/Tanguille/LLMKube/issues/1314)) ([8660c85](https://github.com/Tanguille/LLMKube/commit/8660c85d047965445d668bea8e77e691048fea2a))
* bump broken bartowski phi-4-mini URL to renamed repo ([#514](https://github.com/Tanguille/LLMKube/issues/514)) ([9f15d98](https://github.com/Tanguille/LLMKube/commit/9f15d9891ddc32e118f55b378f8e357e2e7e4d14))
* **cachekey:** note the metal literal mirrors acceleratorMetal ([#993](https://github.com/Tanguille/LLMKube/issues/993)) ([ae9e20d](https://github.com/Tanguille/LLMKube/commit/ae9e20d800b5a6ad486d7e2cce5fc4dc40178c91))
* DGX Spark (GB10) on MicroK8s setup guide ([#717](https://github.com/Tanguille/LLMKube/issues/717)) ([bf7d7a7](https://github.com/Tanguille/LLMKube/commit/bf7d7a7cc456b2f0aa7641c68af016567d4289c2))
* document strict-taint model caches ([#1132](https://github.com/Tanguille/LLMKube/issues/1132)) ([9250996](https://github.com/Tanguille/LLMKube/commit/9250996c42f377dfd2915cfded6fbb219d3fe7ce))
* envtest test-craft guide (status subresource, probe stubs, asset hygiene) ([#1263](https://github.com/Tanguille/LLMKube/issues/1263)) ([#1264](https://github.com/Tanguille/LLMKube/issues/1264)) ([ea4eee6](https://github.com/Tanguille/LLMKube/commit/ea4eee66633053f75789988b94ab736cc5508a59))
* **examples:** spot-capacity GPU NodePool for Foreman gate Jobs (Fixes [#659](https://github.com/Tanguille/LLMKube/issues/659)) ([#824](https://github.com/Tanguille/LLMKube/issues/824)) ([9fa4846](https://github.com/Tanguille/LLMKube/commit/9fa4846338ac6bd84c0f7ae57bb1da2d6cb49231))
* fix DGX Spark guide for ARM64 (GPU operator + GB10 image) ([#718](https://github.com/Tanguille/LLMKube/issues/718)) ([45a4237](https://github.com/Tanguille/LLMKube/commit/45a42372a763a888958c3e4a83ed188c1188c584))
* **foreman:** absolute paths in overview README cross-refs (fix llmkube-web prerender) ([#596](https://github.com/Tanguille/LLMKube/issues/596)) ([b5f6f94](https://github.com/Tanguille/LLMKube/commit/b5f6f94b6a1cc031fc4a758ca8e2ab66b35a88e9))
* **foreman:** enable a coder-capable in-cluster agent (image in llmkube-runtimes) ([#877](https://github.com/Tanguille/LLMKube/issues/877)) ([9bc3d2c](https://github.com/Tanguille/LLMKube/commit/9bc3d2cd280f87449c62d672c70c745bb85d36a3))
* **foreman:** fix AgenticTask names in minimal example ([#1290](https://github.com/Tanguille/LLMKube/issues/1290)) ([7659f29](https://github.com/Tanguille/LLMKube/commit/7659f295cd95d60b6716c0f566ecfa667156212d))
* **foreman:** fix overview link that 404s the site build ([#848](https://github.com/Tanguille/LLMKube/issues/848)) ([2f9b82b](https://github.com/Tanguille/LLMKube/commit/2f9b82b3f84ccc3564f201a1574bd9133b0c41b3))
* **foreman:** move docs/foreman to docs/site/foreman + register in site nav ([#594](https://github.com/Tanguille/LLMKube/issues/594)) ([9fd85bb](https://github.com/Tanguille/LLMKube/commit/9fd85bbe3f4bd2ec9135f71925ba677433b8adc2))
* **foreman:** non-Go projects (language gates) page ([#845](https://github.com/Tanguille/LLMKube/issues/845)) ([d48cf6d](https://github.com/Tanguille/LLMKube/commit/d48cf6d8fe2e942e204eec6686b62a64c3da5bdc))
* **foreman:** replace em dash with colon in README heading ([#1296](https://github.com/Tanguille/LLMKube/issues/1296)) ([8586a37](https://github.com/Tanguille/LLMKube/commit/8586a377eaa15bd3142ba5a00226d8bcc5fbf250))
* **foreman:** v0.8.0 release-prep docs + README Foreman section ([#591](https://github.com/Tanguille/LLMKube/issues/591)) ([5e41df1](https://github.com/Tanguille/LLMKube/commit/5e41df1628311a416765468bf22a28dc2e9d0790))
* **grafana:** AMD (Strix/gfx1151) GPU observability dashboard ([#1188](https://github.com/Tanguille/LLMKube/issues/1188)) ([3da1f2b](https://github.com/Tanguille/LLMKube/commit/3da1f2b45ebea4ff04c69efc1b721a1c4bf5ed70))
* Karpenter GPU autoscaling guide (Fixes [#658](https://github.com/Tanguille/LLMKube/issues/658)) ([#825](https://github.com/Tanguille/LLMKube/issues/825)) ([2d586ef](https://github.com/Tanguille/LLMKube/commit/2d586efecb539e236b387609974e73f270cea18e))
* **macos-metal:** derive curl port from Endpoints (follow-up to [#513](https://github.com/Tanguille/LLMKube/issues/513)) ([#515](https://github.com/Tanguille/LLMKube/issues/515)) ([83085c2](https://github.com/Tanguille/LLMKube/commit/83085c218ff17c2e0a995110b090aca75aa9e99f))
* **macos-metal:** replace broken port-forward step with host-localhost curl ([#513](https://github.com/Tanguille/LLMKube/issues/513)) ([0f7f7a7](https://github.com/Tanguille/LLMKube/commit/0f7f7a7c903660272b53d52c6f5de18838237b5e))
* mention make lint-all in AGENTS.md and CONTRIBUTING.md ([#588](https://github.com/Tanguille/LLMKube/issues/588)) ([39da983](https://github.com/Tanguille/LLMKube/commit/39da983792b93a6ec13d0b44eab7ff71003115e5))
* metrics-driven autoscaling tutorial for InferenceService (HPA, custom metrics, node autoscaling) ([#952](https://github.com/Tanguille/LLMKube/issues/952)) ([ebd5996](https://github.com/Tanguille/LLMKube/commit/ebd5996eada69d7f4569be74f7660989693de925))
* **multi-tenancy:** document GPUQuota is off by default + opt-in/Kueue/HPA/placement notes ([#1313](https://github.com/Tanguille/LLMKube/issues/1313)) ([#1338](https://github.com/Tanguille/LLMKube/issues/1338)) ([3081897](https://github.com/Tanguille/LLMKube/commit/3081897bca396918f67cad7b7ea0823ad7444be2))
* **observability:** multi-tenancy guide + GPUQuota Grafana dashboard ([#1097](https://github.com/Tanguille/LLMKube/issues/1097)) ([#1194](https://github.com/Tanguille/LLMKube/issues/1194)) ([aedbd52](https://github.com/Tanguille/LLMKube/commit/aedbd52e1c3f082c7dc8ec3dc8b0786cacccdcbf))
* **operations:** GPU sharing guide ([#1196](https://github.com/Tanguille/LLMKube/issues/1196) story 6) ([#1208](https://github.com/Tanguille/LLMKube/issues/1208)) ([c9007a3](https://github.com/Tanguille/LLMKube/commit/c9007a3b15540478c55aef040b69917ea7560bb6))
* proposal for owned AMD/Vulkan runtime image and build pipeline ([#726](https://github.com/Tanguille/LLMKube/issues/726)) ([3a1a150](https://github.com/Tanguille/LLMKube/commit/3a1a150a1ae844951771ff3b25a2034ea1b5fe85))
* **proposals:** honest-verdict harness design (declare-then-verify coder gates) ([#1076](https://github.com/Tanguille/LLMKube/issues/1076)) ([630de33](https://github.com/Tanguille/LLMKube/commit/630de33b069c2c52a2824666a77aa9963d1f0696))
* **readme:** lead hero with heterogeneous hardware + Foreman; add AMD to comparison ([#820](https://github.com/Tanguille/LLMKube/issues/820)) ([1439ae5](https://github.com/Tanguille/LLMKube/commit/1439ae546b82a6635e35b32c959ac3952a801e3d))
* register the Karpenter GPU autoscaling guide in nav.yaml ([#954](https://github.com/Tanguille/LLMKube/issues/954)) ([88b9c7d](https://github.com/Tanguille/LLMKube/commit/88b9c7d17d1565193cd8c4be9d1f85482b070aa5))
* **roadmap:** rewrite around the heterogeneous sovereign fleet thesis + milestones ([#632](https://github.com/Tanguille/LLMKube/issues/632)) ([d98b257](https://github.com/Tanguille/LLMKube/commit/d98b257d8ae4880448ecbb74cba566f2763b7fa8))
* **samples:** add air-gapped local file-path model source example ([#1099](https://github.com/Tanguille/LLMKube/issues/1099)) ([#1124](https://github.com/Tanguille/LLMKube/issues/1124)) ([913ff3d](https://github.com/Tanguille/LLMKube/commit/913ff3d05b8e52266952d727361adaddd8ff501b))
* **strix:** document amdgpu.lockup_timeout for device-lost resets ([#886](https://github.com/Tanguille/LLMKube/issues/886)) ([4468d62](https://github.com/Tanguille/LLMKube/commit/4468d6286f6d31d85337041d58e074f2ff66e7e9))


### Miscellaneous

* pin next release to 0.8.1 (Release-As) ([#605](https://github.com/Tanguille/LLMKube/issues/605)) ([a876cc6](https://github.com/Tanguille/LLMKube/commit/a876cc69ee7bda878b2f916a9e2fe1a28dfd6f50))
* release Foreman debut as 0.8.0 (take 2) ([#593](https://github.com/Tanguille/LLMKube/issues/593)) ([a8f0368](https://github.com/Tanguille/LLMKube/commit/a8f036884c9c973af52162260315945e805f7fa2))
